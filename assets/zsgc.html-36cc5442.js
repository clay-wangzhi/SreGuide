import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as s,c as a,b as i,d as e,a as t,e as n}from"./app-f1a45f61.js";const v={},o=n(`<h1 id="创建、复制、移动、删除" tabindex="-1"><a class="header-anchor" href="#创建、复制、移动、删除" aria-hidden="true">#</a> 创建、复制、移动、删除</h1><h3 id="touch命令-创建文件" tabindex="-1"><a class="header-anchor" href="#touch命令-创建文件" aria-hidden="true">#</a> touch命令（创建文件）</h3><p>linux的touch命令不常用，一般在使用make的时候可能会用到，用来修改文件时间戳，或者新建一个不存在的文件。</p><h4 id="语法" tabindex="-1"><a class="header-anchor" href="#语法" aria-hidden="true">#</a> 语法</h4><p><code>touch(选项)(参数)</code></p><p>选项</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>-a：或--time=atime或--time=access或--time=use  只更改存取时间；
