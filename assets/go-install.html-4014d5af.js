import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as i,a}from"./app-08ceb845.js";const d={},l=a(`<h1 id="golang-安装" tabindex="-1"><a class="header-anchor" href="#golang-安装" aria-hidden="true">#</a> Golang 安装</h1><h2 id="windows-安装-go" tabindex="-1"><a class="header-anchor" href="#windows-安装-go" aria-hidden="true">#</a> Windows 安装 go</h2><ol><li>在Go中文网进行Go最新版安装包的下载， https://studygolang.com/dl</li><li>将安装包下载好后直接一步到位next即可</li><li>在控制台输入<code>go version</code>，如果显示了版本号，即代表安装成功</li><li>修改<code>go env</code><ul><li><code>go env -w GO111MODULE=on</code> // 打开GoMOD</li><li><code>go env -w GOPROXY=https://goproxy.cn,direct</code> //配置代理，感谢七牛云</li></ul></li></ol><h2 id="linux-安装-go" tabindex="-1"><a class="header-anchor" href="#linux-安装-go" aria-hidden="true">#</a> Linux 安装 go</h2><ol><li><p>下载</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>cd /opt
