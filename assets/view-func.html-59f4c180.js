import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,e as s}from"./app-4e885309.js";const d={},l=s(`<h1 id="_4-视图、事务、索引、函数" tabindex="-1"><a class="header-anchor" href="#_4-视图、事务、索引、函数" aria-hidden="true">#</a> 4 视图、事务、索引、函数</h1><h2 id="_1-视图【view】" tabindex="-1"><a class="header-anchor" href="#_1-视图【view】" aria-hidden="true">#</a> 1 视图【view】</h2><p>1、 视图是一张虚拟表，它表示一张表的部分或多张表的综合的结构。</p><p>2、 视图仅仅是表结构，没有表数据。视图的结构和数据建立在表的基础上。</p><h3 id="_1-1-创建视图" tabindex="-1"><a class="header-anchor" href="#_1-1-创建视图" aria-hidden="true">#</a> 1.1 创建视图</h3><p>语法</p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>create [or replace] view 视图的名称
as
	select语句;
