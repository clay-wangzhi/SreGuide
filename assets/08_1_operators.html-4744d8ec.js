import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as r,c as v,b as e,d as i,e as a,a as n}from"./app-fc8cee6e.js";const t={},u=n(`<h1 id="_8-1-运算符" tabindex="-1"><a class="header-anchor" href="#_8-1-运算符" aria-hidden="true">#</a> 8.1 运算符</h1><h2 id="赋值运算符" tabindex="-1"><a class="header-anchor" href="#赋值运算符" aria-hidden="true">#</a> 赋值运算符</h2><p><em>变量赋值</em>，初始化或改变一个变量的值。</p><h3 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a> =</h3><p>等号<code>=</code>赋值运算符，既可用于算术赋值，也可用于字符串赋值。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>var=27
