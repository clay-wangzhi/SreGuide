import{_ as n,e as s}from"./app.4792bd1f.js";const a={},e=s(`<h1 id="helm-\u5B89\u88C5\u914D\u7F6E" tabindex="-1"><a class="header-anchor" href="#helm-\u5B89\u88C5\u914D\u7F6E" aria-hidden="true">#</a> Helm \u5B89\u88C5\u914D\u7F6E</h1><h2 id="\u5B89\u88C5" tabindex="-1"><a class="header-anchor" href="#\u5B89\u88C5" aria-hidden="true">#</a> \u5B89\u88C5</h2><p>\u4E0B\u8F7D\u4E8C\u8FDB\u5236\u6587\u4EF6</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token builtin class-name">export</span> <span class="token assign-left variable">helmversion</span><span class="token operator">=</span><span class="token number">3.7</span>.2
