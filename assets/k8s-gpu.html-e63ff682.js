import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as s,e}from"./app-0d7f3073.js";const l={},i=e(`<h1 id="k8s-适配-gpu" tabindex="-1"><a class="header-anchor" href="#k8s-适配-gpu" aria-hidden="true">#</a> k8s 适配 GPU</h1><h2 id="gpu-安装步骤" tabindex="-1"><a class="header-anchor" href="#gpu-安装步骤" aria-hidden="true">#</a> GPU 安装步骤</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># centos7 内核升级后   GPU 安装步骤</span>
