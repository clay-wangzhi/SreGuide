import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as t,c as r,b as s,d as n,e,a as i}from"./app-2a698b89.js";const p={},c=i(`<h1 id="_11-2-嵌套循环" tabindex="-1"><a class="header-anchor" href="#_11-2-嵌套循环" aria-hidden="true">#</a> 11.2 嵌套循环</h1><p>嵌套循环，顾名思义就是在循环里面还有循环。外层循环会不断的触发内层循环直到外层循环结束。当然，你仍然可以使用 <code>break</code> 可以终止外层或内层的循环。</p><p>样例 11-20. 嵌套循环</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
