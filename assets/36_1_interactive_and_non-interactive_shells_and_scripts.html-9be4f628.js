import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,a as s}from"./app-92a149ab.js";const l={},d=s(`<h1 id="_36-1-交互和非交互shell以及脚本" tabindex="-1"><a class="header-anchor" href="#_36-1-交互和非交互shell以及脚本" aria-hidden="true">#</a> 36.1 交互和非交互shell以及脚本</h1><p>交互shell从tty读取用户输入。shell默认会读取启动文件，显示提示符和打开任务控制等。用户可以和shell交互。</p><p>脚本总是运行在非交互的shell上。同样，脚本可以访问它自己的tty，这使得在脚本中依然可以模拟出交互的shell。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#!/bin/bash
MY_PROMPT=&#39;$ &#39;
while :
    do
        echo -n &quot;$MY_PROMPT&quot;
