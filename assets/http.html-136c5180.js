import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-a7feade7.js";const i={},t=e(`<h1 id="_3-2-nginxhttp块配置" tabindex="-1"><a class="header-anchor" href="#_3-2-nginxhttp块配置" aria-hidden="true">#</a> 3.2 nginxHTTP块配置</h1><h2 id="_1-配置块的嵌套" tabindex="-1"><a class="header-anchor" href="#_1-配置块的嵌套" aria-hidden="true">#</a> 1 配置块的嵌套</h2><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">http</span></span> <span class="token punctuation">{</span>
