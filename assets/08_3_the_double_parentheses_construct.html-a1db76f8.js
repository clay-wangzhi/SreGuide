import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as i,a as s}from"./app-679550bc.js";const l={},d=s(`<h1 id="_8-3-双圆括号结构" tabindex="-1"><a class="header-anchor" href="#_8-3-双圆括号结构" aria-hidden="true">#</a> 8.3 双圆括号结构</h1><p>与<code>let</code>命令类似，<code>(( ... ))</code> 结构允许对算术表达式的扩展和求值。它是<code>let</code>命令的简化形式。例如，a=$(( 5 + 3 )) 会将变量a赋值成 5 + 3，也就是8。在Bash中，双圆括号结构也允许以C风格的方式操作变量。例如，(( var++ ))。</p><p><strong>样例 8-5. 以C风格的方式操作变量</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#!/bin/bash
# c-vars.sh
# 以C风格的方式操作变量，使用(( ... ))结构
