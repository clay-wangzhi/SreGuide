import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as d,c as r,b as e,d as i,a as s,e as v}from"./app-f536079c.js";const t={},c=v(`<h1 id="_4-2-jenkins流水线语法" tabindex="-1"><a class="header-anchor" href="#_4-2-jenkins流水线语法" aria-hidden="true">#</a> 4.2 Jenkins流水线语法</h1><p>您好，本模块主要学习声明式流水线的核心语法，掌握核心语法便于编写Jenkinsfile 😀</p><hr><h2 id="声明式流水线" tabindex="-1"><a class="header-anchor" href="#声明式流水线" aria-hidden="true">#</a> 声明式流水线</h2><p>声明式Pipleine是官方推荐的语法，声明式语法更加简洁。所有的声明式Pipeline都必须包含一个 pipeline块中，比如：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>pipeline {
    //run
}
