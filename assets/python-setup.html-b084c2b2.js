import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as a,c as r,a as e,b as i,d as n,e as t}from"./app-db2140e1.js";const p={},o=e("h1",{id:"_6-2-python-的-setup-py-详解",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_6-2-python-的-setup-py-详解","aria-hidden":"true"},"#"),i(" 6.2 Python 的 setup.py 详解")],-1),u={href:"https://zhuanlan.zhihu.com/p/276461821",target:"_blank",rel:"noopener noreferrer"},c=t(`<h2 id="_1-为什么需要对项目分发打包" tabindex="-1"><a class="header-anchor" href="#_1-为什么需要对项目分发打包" aria-hidden="true">#</a> 1. 为什么需要对项目分发打包？</h2><p>平常我们习惯了使用 pip 来安装一些第三方模块，这个安装过程之所以简单，是因为模块开发者为我们默默地为我们做了所有繁杂的工作，而这个过程就是 <code>打包</code>。</p><p>打包，就是将你的源代码进一步封装，并且将所有的项目部署工作都事先安排好，这样使用者拿到后即装即用，不用再操心如何部署的问题（如果你不想对照着一堆部署文档手工操作的话）。</p><p>不管你是在工作中，还是业余准备自己写一个可以上传到 PyPI 的项目，你都要学会如何打包你的项目。</p><p>Python 发展了这么些年了，项目打包工具也已经很成熟了。他们都有哪些呢？</p><p>你可能听过 <code>disutils</code>、 <code>distutils</code> 、<code>distutils2</code>、<code>setuptools</code>等等，好像很熟悉，却又很陌生，他们都是什么关系呢？</p><h2 id="_2-包分发的始祖-distutils" tabindex="-1"><a class="header-anchor" href="#_2-包分发的始祖-distutils" aria-hidden="true">#</a> 2. 包分发的始祖：distutils</h2><p><code>distutils</code> 是 Python 的一个标准库，从命名上很容易看出它是一个分发（distribute）工具（utlis），它是 Python 官方开发的一个分发打包工具，所有后续的打包工具，全部都是基于它进行开发的。</p><p><code>distutils</code> 的精髓在于编写 setup.py，它是模块分发与安装的指导文件。</p><p>那么如何编写 setup.py 呢？这里面的内容非常多，我会在后面进行详细的解析，请你耐心往下看。</p><p>你有可能没写过 setup.py ，但你绝对使用过 setup.py 来做一些事情，比如下面这条命令，我们经常用它来进行模块的安装。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>$ python setup.py install
