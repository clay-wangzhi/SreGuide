import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,e as s}from"./app-be40ec11.js";const d={},t=s(`<h1 id="etc-security-limits-conf-详解与配置" tabindex="-1"><a class="header-anchor" href="#etc-security-limits-conf-详解与配置" aria-hidden="true">#</a> /etc/security/limits.conf 详解与配置</h1><h2 id="一、-etc-security-limits-conf-详解" tabindex="-1"><a class="header-anchor" href="#一、-etc-security-limits-conf-详解" aria-hidden="true">#</a> 一、 /etc/security/limits.conf 详解</h2><p><code>/etc/security/limits.conf</code> 文件实际是 Linux PAM（插入式认证模块，Pluggable Authentication Modules）中 <code>pam_limits.so</code> 的配置文件，而且只针对于单个会话。 该设置不会影响系统服务的资源限制。还要注意 <code>/etc/security/limits.d/</code> 的这个目录，</p><h3 id="etc-security-limits-conf-配置解析" tabindex="-1"><a class="header-anchor" href="#etc-security-limits-conf-配置解析" aria-hidden="true">#</a> /etc/security/limits.conf 配置解析</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># /etc/security/limits.conf
#
