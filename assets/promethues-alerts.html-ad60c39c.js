import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as n,e as l}from"./app-e4524484.js";const i={},s=l(`<h1 id="prometheusalert" tabindex="-1"><a class="header-anchor" href="#prometheusalert" aria-hidden="true">#</a> PrometheusAlert</h1><p>Prometheus Alert是开源的运维告警中心消息转发系统,支持主流的监控系统Prometheus,Zabbix,日志系统Graylog和数据可视化系统Grafana发出的预警消息,支持钉钉,微信,华为云短信,腾讯云短信,腾讯云电话,阿里云短信,阿里云电话等</p><h2 id="文档" tabindex="-1"><a class="header-anchor" href="#文档" aria-hidden="true">#</a> 文档</h2><p>https://feiyu563.gitbook.io/prometheusalert/</p><h2 id="自定义的告警模板" tabindex="-1"><a class="header-anchor" href="#自定义的告警模板" aria-hidden="true">#</a> 自定义的告警模板</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>{{ $var := .externalURL}}{{ range $k,$v:=.alerts }}
