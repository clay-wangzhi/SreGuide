<template><h1 id="linux-du、df统计的硬盘使用情况不一致问题" tabindex="-1"><a class="header-anchor" href="#linux-du、df统计的硬盘使用情况不一致问题" aria-hidden="true">#</a> Linux，du、df统计的硬盘使用情况不一致问题</h1>
