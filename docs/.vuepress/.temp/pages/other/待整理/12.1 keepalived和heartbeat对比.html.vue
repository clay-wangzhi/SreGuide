<template><div><h1 id="高可用开源方案-keepalived-vs-heartbeat对比" tabindex="-1"><a class="header-anchor" href="#高可用开源方案-keepalived-vs-heartbeat对比" aria-hidden="true">#</a> 高可用开源方案 Keepalived VS Heartbeat对比</h1>
