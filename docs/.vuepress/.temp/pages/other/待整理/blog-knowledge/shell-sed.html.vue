<template><p>Let's learn the sed command together！</p>
<!--more-->
...
<h3 id="a命令" tabindex="-1"><a class="header-anchor" href="#a命令" aria-hidden="true">#</a> <code>a</code>命令</h3>
<ul>
...
<h3 id="c命令" tabindex="-1"><a class="header-anchor" href="#c命令" aria-hidden="true">#</a> <code>c</code>命令</h3>
<ul>
<li>
...
<h3 id="i命令" tabindex="-1"><a class="header-anchor" href="#i命令" aria-hidden="true">#</a> <code>i</code>命令</h3>
<p>与<code>a</code>命令类似，只不过在匹配的行前面插入字符串行，不举例了。</p>
<h3 id="d命令" tabindex="-1"><a class="header-anchor" href="#d命令" aria-hidden="true">#</a> <code>d</code>命令</h3>
<ul>
<li><code>sed '4,$d' test.txt</code> 从第四行到最后一行全部删除</li>
</ul>
<h3 id="p命令" tabindex="-1"><a class="header-anchor" href="#p命令" aria-hidden="true">#</a> <code>p</code>命令</h3>
<ul>
...
<h3 id="s命令" tabindex="-1"><a class="header-anchor" href="#s命令" aria-hidden="true">#</a> <code>s</code>命令</h3>
<ul>
...
<h3 id="e命令" tabindex="-1"><a class="header-anchor" href="#e命令" aria-hidden="true">#</a> <code>e</code>命令</h3>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sed -e '1,5d' -e 's/test/check/' file
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>上面sed表达式的第一条命令删除1至5行，第二条命令用check替换test。命令的执行顺序对结果有影响。如果两个命令都是替换命令，那么第一个替换命令将影响第二个替换命令的结果。</p>
<h3 id="n命令" tabindex="-1"><a class="header-anchor" href="#n命令" aria-hidden="true">#</a> <code>n</code>命令</h3>
<p>如果test被匹配，则移动到匹配行的下一行，替换这一行的aa，变为bb，并打印该行，然后继续：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sed '/test/{ n; s/aa/bb/; }' file
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="q命令" tabindex="-1"><a class="header-anchor" href="#q命令" aria-hidden="true">#</a> <code>q</code>命令</h3>
<p>打印完第10行后，退出sed</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sed '10q' file
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="w命令" tabindex="-1"><a class="header-anchor" href="#w命令" aria-hidden="true">#</a> <code>w</code>命令</h3>
<p>在example中所有包含test的行都被写入file里：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sed -n '/test/w file' example
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="已匹配字符串标记" tabindex="-1"><a class="header-anchor" href="#已匹配字符串标记" aria-hidden="true">#</a> 已匹配字符串标记&amp;</h3>
<p>正则表达式 \w+ 匹配每一个单词，使用 [&amp;] 替换它，&amp; 对应于之前所匹配到的单词：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>echo this is a test line | sed 's/\w\+/[&amp;]/g'
[this] [is] [a] [test] [line]
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>所有以192.168.0.1开头的行都会被替换成它自已加localhost：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sed 's/^192.168.0.1/&amp;localhost/' file
192.168.0.1localhost
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="子串匹配标记-1" tabindex="-1"><a class="header-anchor" href="#子串匹配标记-1" aria-hidden="true">#</a> 子串匹配标记\1</h3>
<p>匹配给定样式的其中一部分：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>echo this is digit 7 in a number | sed 's/digit \([0-9]\)/\1/'
this is 7 in a number
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>命令中 digit 7，被替换成了 7。样式匹配到的子串是 7，(..) 用于匹配子串，对于匹配到的第一个子串就标记为 <strong>\1</strong>，依此类推匹配到的第二个结果就是 <strong>\2</strong>，例如：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>echo aaa BBB | sed 's/\([a-z]\+\) \([A-Z]\+\)/\2 \1/'
BBB aaa
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>love被标记为1，所有loveable会被替换成lovers，并打印出来：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sed -n 's/\(love\)able/\1rs/p' file
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="选定行的范围-逗号" tabindex="-1"><a class="header-anchor" href="#选定行的范围-逗号" aria-hidden="true">#</a> 选定行的范围：,（逗号）</h3>
<p>所有在模板test和check所确定的范围内的行都被打印：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sed -n '/test/,/check/p' file
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>打印从第5行开始到第一个包含以test开始的行之间的所有行：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sed -n '5,/^test/p' file
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>对于模板test和west之间的行，每行的末尾用字符串aaa bbb替换：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sed '/test/,/west/s/$/aaa bbb/' file
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="打印奇数行或偶数行" tabindex="-1"><a class="header-anchor" href="#打印奇数行或偶数行" aria-hidden="true">#</a> 打印奇数行或偶数行</h3>
<p>方法1：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sed -n 'p;n' test.txt  #奇数行
sed -n 'n;p' test.txt  #偶数行

</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>方法2：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sed -n '1~2p' test.txt  #奇数行
sed -n '2~2p' test.txt  #偶数行
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h2 id="基本正则表达式" tabindex="-1"><a class="header-anchor" href="#基本正则表达式" aria-hidden="true">#</a> 基本正则表达式</h2>
<table>
<thead>
<tr>
<th>元字符</th>
