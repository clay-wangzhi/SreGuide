...
<h2 id="zabbix-proxy安装" tabindex="-1"><a class="header-anchor" href="#zabbix-proxy安装" aria-hidden="true">#</a> zabbix-proxy安装</h2>
<ol>
<li>下载roles</li>
</ol>
...
<h2 id="zabbix-agent安装" tabindex="-1"><a class="header-anchor" href="#zabbix-agent安装" aria-hidden="true">#</a> zabbix-agent安装</h2>
<ol>
<li>下载roles</li>
</ol>
