<template><div><h1 id="_4-mysql监控模块" tabindex="-1"><a class="header-anchor" href="#_4-mysql监控模块" aria-hidden="true">#</a> 4 MySQL监控模块</h1>
<blockquote>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>> grant all on *.* to monitor@'localhost' identified by 'W***';
> flush privileges;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="修改zabbix-agent配置文件" tabindex="-1"><a class="header-anchor" href="#修改zabbix-agent配置文件" aria-hidden="true">#</a> 修改zabbix_agent配置文件</h3>
<ol>
<li>设置完帐户之后在被监控端新建/etc/zabbix/etc/.my.cnf以提供Zabbix Agent访问数据库，内容类似如下</li>
</ol>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>#vim /etc/zabbix/etc/.my.cnf
[mysql]
host=localhost
user=monitor
password=W***
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>#vim userparameter_mysql.conf
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/mysql配置.png" alt=""></p>
<h3 id="重启agent服务" tabindex="-1"><a class="header-anchor" href="#重启agent服务" aria-hidden="true">#</a> 重启agent服务</h3>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>service zabbix_agentd restart
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="zabbix-web设置" tabindex="-1"><a class="header-anchor" href="#zabbix-web设置" aria-hidden="true">#</a> zabbix-web设置</h3>
...
<ol>
<li>在<code v-pre>/opt/monitor</code>目录下添加主从监控脚本</li>
</ol>
<p>vim mysql_slave.sh</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>#!/usr/bin/env bash
user='monitor'
passwd=
...
<p>在<code v-pre>etc/zabbix/zabbix_agentd.conf</code>中新加</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>UserParameter=mysql.replication,/opt/monitor/mysql_slave.sh
...
<p>在<code v-pre>etc/zabbix/zabbix_agentd.conf</code>中新加</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>UserParameter=mysql.linknum, ss -an | grep 3306 | grep -c ESTAB
