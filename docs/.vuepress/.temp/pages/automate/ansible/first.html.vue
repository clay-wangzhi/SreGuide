<template><h1 id="_1-初识ansible" tabindex="-1"><a class="header-anchor" href="#_1-初识ansible" aria-hidden="true">#</a> 1 初识Ansible</h1>
<h2 id="_1-ansible简介" tabindex="-1"><a class="header-anchor" href="#_1-ansible简介" aria-hidden="true">#</a> 1 Ansible简介</h2>
...
<h3 id="_1-1-ansible特性" tabindex="-1"><a class="header-anchor" href="#_1-1-ansible特性" aria-hidden="true">#</a> 1.1 Ansible特性</h3>
<ul>
...
<h3 id="_1-2-ansible的基本组件" tabindex="-1"><a class="header-anchor" href="#_1-2-ansible的基本组件" aria-hidden="true">#</a> 1.2 Ansible的基本组件</h3>
<p><img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/ansible1-1585014469983.png" alt="ansible1" loading="lazy"></p>
<ul>
<li>核心：ansible</li>
...
<h3 id="_1-3-ansible工作机制" tabindex="-1"><a class="header-anchor" href="#_1-3-ansible工作机制" aria-hidden="true">#</a> 1.3 Ansible工作机制</h3>
<p>Ansible 在管理节点将 Ansible 模块通过 SSH 协议（或者 Kerberos、LDAP）推送到被管理端执行，执行完之后自动删除，可以使用版本控制系统（git/svn）来管理自定义模块及playbooks。</p>
<p><img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/ansible2-1585014469997.png" alt="ansible2" loading="lazy"></p>
<h2 id="_2-ansible安装" tabindex="-1"><a class="header-anchor" href="#_2-ansible安装" aria-hidden="true">#</a> 2 Ansible安装</h2>
<h3 id="_2-1-yum-安装-推荐" tabindex="-1"><a class="header-anchor" href="#_2-1-yum-安装-推荐" aria-hidden="true">#</a> 2.1 yum 安装（推荐）</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 配置epel源</span>
...
<h3 id="_2-2-源码安装-推荐" tabindex="-1"><a class="header-anchor" href="#_2-2-源码安装-推荐" aria-hidden="true">#</a> 2.2 源码安装（推荐）</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 解决依赖关系：</span>
yum <span class="token function">install</span> -y python36 python36-devel python36-setuptools gcc libffi-devel openssl-devel
...
<span class="token function">cp</span> -r examples/* /etc/ansible
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><h3 id="_2-3-pip-安装" tabindex="-1"><a class="header-anchor" href="#_2-3-pip-安装" aria-hidden="true">#</a> 2.3  pip 安装</h3>
<p>Ansible每个版本释放出来之后，都首先提交到Pypi,所以任何操作系统，都可以使用pip工具来安装最新版的Ansible。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>pip3 <span class="token function">install</span> ansible
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>但要注意，使用各系统的包管理I具(如yum)安装Ansible时自动会提供-些配置文件，如/etc/ansible/ansible. cfg。而使用pip安装的Ansible默认不提供配置文件。</p>
<h2 id="_3-ansible-参数补全功能" tabindex="-1"><a class="header-anchor" href="#_3-ansible-参数补全功能" aria-hidden="true">#</a> 3 Ansible 参数补全功能</h2>
<p>从Ansible 2.9版本开始，它支持命令的选项补全功能，它依赖于python的argcomplete插件</p>
<p>安装argcomplete:</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>yum -y install python-argcomplete
pip3 install argcomplete
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>安装完成后，激活插件</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>activate-global-python-argcomplete 
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>重新进去终端，即可使用tab参数补全功能</p>
<h2 id="_4-ansible配置文件管理" tabindex="-1"><a class="header-anchor" href="#_4-ansible配置文件管理" aria-hidden="true">#</a> 4 Ansible配置文件管理</h2>
<h3 id="_4-1-配置文件优先级" tabindex="-1"><a class="header-anchor" href="#_4-1-配置文件优先级" aria-hidden="true">#</a> 4.1 配置文件优先级</h3>
...
<h3 id="_4-2-配置文件详解" tabindex="-1"><a class="header-anchor" href="#_4-2-配置文件详解" aria-hidden="true">#</a> 4.2 配置文件详解</h3>
<p>Ansible 配置文件采用ini风格进行配置，每一项配置都使用<code>key=value</code>的方式进行配置</p>
<h4 id="_4-2-1-配置文件分段说明" tabindex="-1"><a class="header-anchor" href="#_4-2-1-配置文件分段说明" aria-hidden="true">#</a> 4.2.1 配置文件分段说明</h4>
...
<h4 id="_4-2-2-配置参数说明" tabindex="-1"><a class="header-anchor" href="#_4-2-2-配置参数说明" aria-hidden="true">#</a> 4.2.2 配置参数说明</h4>
