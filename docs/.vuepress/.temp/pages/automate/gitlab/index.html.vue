<template><h1 id="gitlab备份迁移升级-集成openldap" tabindex="-1"><a class="header-anchor" href="#gitlab备份迁移升级-集成openldap" aria-hidden="true">#</a> gitlab备份迁移升级&amp;集成openldap</h1>
<h2 id="gitlab安装" tabindex="-1"><a class="header-anchor" href="#gitlab安装" aria-hidden="true">#</a> gitlab安装</h2>
<h3 id="安装相关依赖" tabindex="-1"><a class="header-anchor" href="#安装相关依赖" aria-hidden="true">#</a> 安装相关依赖</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>yum <span class="token function">install</span> -y <span class="token function">curl</span> policycoreutils-python openssh-server
yum <span class="token function">install</span> postfix
systemctl <span class="token builtin class-name">enable</span> postfix
systemctl start postfix
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h3 id="镜像切换" tabindex="-1"><a class="header-anchor" href="#镜像切换" aria-hidden="true">#</a> 镜像切换</h3>
<p>切换为国内的清华源</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># cat gitlab_gitlab-ce.repo </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>由于不同版本号的备份文件不能相互使用，下载旧gitlab中的对应的版本</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>yum -y <span class="token function">install</span> gitlab-ce-11.5.1
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="配置使用" tabindex="-1"><a class="header-anchor" href="#配置使用" aria-hidden="true">#</a> 配置使用</h3>
...
gitlab-ctl restart
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h2 id="gitlab备份-恢复" tabindex="-1"><a class="header-anchor" href="#gitlab备份-恢复" aria-hidden="true">#</a> gitlab备份&amp;恢复</h2>
<p>Gitlab 成功运行起来之后，最终的事情就是定期的备份，遇到问题后的还原。</p>
<h3 id="备份配置" tabindex="-1"><a class="header-anchor" href="#备份配置" aria-hidden="true">#</a> 备份配置</h3>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>gitlab_rails<span class="token punctuation">[</span><span class="token string">'backup_path'</span><span class="token punctuation">]</span> <span class="token operator">=</span> <span class="token string">'/your_wish/backups'</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>然后<code>gitlabctl-reconfigure</code>生效。</p>
<h3 id="手动备份" tabindex="-1"><a class="header-anchor" href="#手动备份" aria-hidden="true">#</a> 手动备份</h3>
...
<h3 id="自动备份" tabindex="-1"><a class="header-anchor" href="#自动备份" aria-hidden="true">#</a> 自动备份</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">0</span> <span class="token number">2</span> * * * /opt/gitlab/bin/gitlab-backup create <span class="token assign-left variable">CRON</span><span class="token operator">=</span><span class="token number">1</span>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>cp 11493107454_2018_04_25_10.6.4-ce_gitlab_backup.tar /var/opt/gitlab/backups/
chown git.git /var/opt/gitlab/backups/11493107454_2018_04_25_10.6.4-ce_gitlab_backup.tar
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>Stop the processes that are connected to the database. Leave the rest of GitLab running:</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>gitlab-ctl stop unicorn
gitlab-ctl stop sidekiq
<span class="token comment"># Verify</span>
gitlab-ctl status
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>Next, restore the backup, specifying the timestamp of the backup you wish to restore:</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># This command will overwrite the contents of your GitLab database!</span>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>gitlab-ctl reconfigure
gitlab-ctl restart
gitlab-rake gitlab:check <span class="token assign-left variable">SANITIZE</span><span class="token operator">=</span>true
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>If there is a GitLab version mismatch between your backup tar file and the installed version of GitLab, the restore command will abort with an error. Install the <a href="https://packages.gitlab.com/gitlab/" target="_blank" rel="noopener noreferrer">correct GitLab version<ExternalLinkIcon/></a> and try again.</p>
<h2 id="gitlab升级" tabindex="-1"><a class="header-anchor" href="#gitlab升级" aria-hidden="true">#</a> gitlab升级</h2>
...
<p>例如</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>yum -y <span class="token function">install</span> gitlab-ce-11.11.8
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>每升级一次，重载一下配置，重启一下gitlab</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>gitlab-ctl reconfigure
gitlab-ctl restart
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h2 id="gitlab集成openldap" tabindex="-1"><a class="header-anchor" href="#gitlab集成openldap" aria-hidden="true">#</a> gitlab集成openldap</h2>
<h3 id="setting-up-ldap-sign-in" tabindex="-1"><a class="header-anchor" href="#setting-up-ldap-sign-in" aria-hidden="true">#</a> Setting up LDAP sign-in</h3>
...
<p>以下是我ldap的配置</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment">### LDAP Settings</span>
