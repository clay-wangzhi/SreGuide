<template><div><h1 id="docker-设置代理" tabindex="-1"><a class="header-anchor" href="#docker-设置代理" aria-hidden="true">#</a> Docker 设置代理</h1>
<blockquote>
<p>起因：由于有些国外的镜像拉取不下来，所以设置翻墙代理，下载成功后，再导出<code v-pre>docker save xx:tar -o xx.tar</code>，传输到需要的节点导入<code v-pre>docker load -i xx.tar</code></p>
</blockquote>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">## 先停止Docker</span>
