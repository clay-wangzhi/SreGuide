<template><div><h1 id="etcd-问题、调优、监控" tabindex="-1"><a class="header-anchor" href="#etcd-问题、调优、监控" aria-hidden="true">#</a> etcd 问题、调优、监控</h1>
<blockquote>
...
<img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark.png" alt="img"></p>
<p>宕机后：102 成为新 leader，2 个 member</p>
<p><img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark-20210920142348851.png" alt="img"></p>
<p>过程：</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>91d63231b87fadda <span class="token punctuation">[</span>term <span class="token number">7</span><span class="token punctuation">]</span> received MsgTimeoutNow from 8a4bb0af2f19bd46 and starts an election to get leadership.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<ul>
<li>102(91d63231b87fadda)成为新一任的候选人，然后自己投给了自己，获得 1 票</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>91d63231b87fadda became candidate at term <span class="token number">8</span>
91d63231b87fadda received MsgVoteResp from 91d63231b87fadda at term <span class="token number">8</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<ul>
<li>102(91d63231b87fadda)发送给 挂掉的101 和 另一个100，希望他们也投给自己</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>91d63231b87fadda <span class="token punctuation">[</span>logterm: <span class="token number">7</span>, index: <span class="token number">4340153</span><span class="token punctuation">]</span> sent MsgVote request to 8a4bb0af2f19bd46 at term <span class="token number">8</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<ul>
<li>102 肯定收不到 101 的回应，因为 101 已经挂掉</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>etcd<span class="token punctuation">[</span><span class="token number">24203</span><span class="token punctuation">]</span>: lost the TCP streaming connection with peer 8a4bb0af2f19bd46 <span class="token punctuation">(</span>stream MsgApp v2 reader<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<ul>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>9feab580a25dd270 <span class="token punctuation">[</span>term: <span class="token number">7</span><span class="token punctuation">]</span> received a MsgVote message with higher term from 91d63231b87fadda <span class="token punctuation">[</span>term: <span class="token number">8</span><span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<ul>
<li>102 获得了 2 票，一票是自己，一票是 100，超过半数，成为新的 leader。任期为 8</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>91d63231b87fadda elected leader 91d63231b87fadda at term <span class="token number">8</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<ul>
<li>更换完成</li>
...
<p>2节点正常运行：
<img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark11.png" alt="img"></p>
<p>1台宕机后：
<img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark12.png" alt="img"></p>
<ul>
...
<p><img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark13.png" alt="img"></p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>The majority side becomes the available cluster and the minority side is unavailable<span class="token punctuation">;</span> there is no “split-brain” <span class="token keyword">in</span> etcd.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<p>以网络分区导致脑裂为例，一开始有5个节点, Node 5 为 Leader</p>
<p><img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark-20210920142349298.png" alt="img"></p>
...
<p><img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark-20210920142349358.png" alt="img"></p>
...
<p>Copy</p>
<p>3.生成基础 ca 证书</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>cfssl gencert <span class="token parameter variable">-initca</span> ca-csr.json <span class="token operator">|</span> cfssljson <span class="token parameter variable">-bare</span> ca
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<p>执行后会生成三个文件：</p>
<ul>
...
<p>etcd 启动配置示例</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>./etcd <span class="token punctuation">\</span>
...
<img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark14.png" alt="img"></li>
</ul>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>--client-cert-auth<span class="token operator">=</span>true <span class="token punctuation">\</span>
--cert-file<span class="token operator">=</span>/etc/etcd/ssl/etcd.pem <span class="token punctuation">\</span>
--key-file<span class="token operator">=</span>/etc/etcd/ssl/etcd-key.pem <span class="token punctuation">\</span>
--peer-cert-file<span class="token operator">=</span>/etc/etcd/ssl/etcd.pem <span class="token punctuation">\</span>
--peer-key-file<span class="token operator">=</span>/etc/etcd/ssl/etcd-key.pem <span class="token punctuation">\</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>--peer-trusted-ca-file<span class="token operator">=</span>/etc/etcd/ssl/ca.pem <span class="token punctuation">\</span>
--initial-advertise-peer-urls https://100.0.0.0:2380 <span class="token punctuation">\</span>
--listen-peer-urls https://100.0.0.0:2380 <span class="token punctuation">\</span>
--listen-client-urls https://100.0.0.0:2379,https://127.0.0.1:2379 <span class="token punctuation">\</span>
--advertise-client-urls https://100.0.0.0:2379 <span class="token punctuation">\</span>
...
--initial-cluster etcd-0<span class="token operator">=</span>https://100.0.0.0:2380,etcd-1<span class="token operator">=</span>https://100.0.0.1:2380,etcd-2<span class="token operator">=</span>https://100.0.0.2:2380 <span class="token punctuation">\</span>
--initial-cluster-state new <span class="token punctuation">\</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code> took too long <span class="token punctuation">(</span><span class="token number">1</span>.483848046s<span class="token punctuation">)</span> to execute
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>etcdctl put demo <span class="token number">101</span> <span class="token parameter variable">-w</span> json
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<p>取值：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>etcdctl get demo 默认 <span class="token parameter variable">--rev</span><span class="token operator">=</span><span class="token number">0</span>即最新值<span class="token operator">=</span><span class="token number">103</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<p>观察 key的变化:</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>etcdctl <span class="token function">watch</span>  foo <span class="token parameter variable">--rev</span><span class="token operator">=</span><span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
...
<p>手动压缩</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>etcdctl compact <span class="token number">5</span>。 在 <span class="token number">5</span> 之前的所有版本都会被压缩，不可访问
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>etcd --auto-compaction-retention<span class="token operator">=</span><span class="token number">1</span> 代表 <span class="token number">1</span> 小时压缩一次
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>– etcd-compaction-interval 即默认 <span class="token number">5</span> 分钟一次
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<p>你可以在 etcd 中看到这样的压缩日志，5 分钟一次：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>Apr <span class="token number">25</span> <span class="token number">11</span>:05:20  etcd<span class="token punctuation">[</span><span class="token number">2195</span><span class="token punctuation">]</span>: store.index: compact <span class="token number">433912</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># defrag命令默认只对本机有效</span>
etcdctl defrag 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<p>如果etcd没有运行，可以直接整理目录中db的碎片</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>etcdctl defrag --data-dir <span class="token operator">&lt;</span>path-to-etcd-data-dir<span class="token operator">></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
<p>碎片整理会阻塞对etcd的读写操作，因此偶尔一次大量数据的defrag最好逐台进行，以免影响集群稳定性。</p>
<p>etcdctl执行后的返回 <code v-pre>Finished defragmenting etcd member[https://127.0.0.1:2379]</code></p>
...
<p><img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark-20210920142349529.png" alt="img"></p>
...
<p>如果遇到空间不足，可以这样操作：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 获取当前版本号</span>
...
<p>使用命令etcdctl：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>etcdctl snapshot save backup.db
...
+----------+----------+------------+------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Bash</p>
<p>Copy</p>
...
<p>具体操作：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 增加一个节点作为learner</span>
...
<p><code v-pre>request ... took too long to execute</code> 这类报错也是同理</p>
...
<p><img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark15.png" alt="img">
<img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark-20210920142349763.png" alt="img">
<img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark16.png" alt="img">
<img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/watermark-20210920142350027.png" alt="img"></p>
