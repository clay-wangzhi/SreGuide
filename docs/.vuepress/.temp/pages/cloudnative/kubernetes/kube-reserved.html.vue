<template><div><h1 id="k8s-node-配置资源预留" tabindex="-1"><a class="header-anchor" href="#k8s-node-配置资源预留" aria-hidden="true">#</a> k8s node 配置资源预留</h1>
...
<p><code v-pre>/var/lib/kubelet/config.yaml</code></p>
