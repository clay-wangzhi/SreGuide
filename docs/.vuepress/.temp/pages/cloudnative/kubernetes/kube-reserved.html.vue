<template><h1 id="k8s-node-配置资源预留" tabindex="-1"><a class="header-anchor" href="#k8s-node-配置资源预留" aria-hidden="true">#</a> k8s node 配置资源预留</h1>
...
<ul>
<li><a href="https://www.qikqiak.com/k8strain2/maintain/reserved/" target="_blank" rel="noopener noreferrer">资源预留 | 阳明<ExternalLinkIcon/></a></li>
</ul>
</template>
