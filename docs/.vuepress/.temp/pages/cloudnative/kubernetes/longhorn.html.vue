<template><h1 id="longorn-安装配置" tabindex="-1"><a class="header-anchor" href="#longorn-安装配置" aria-hidden="true">#</a> Longorn 安装配置</h1>
<h2 id="安装配置" tabindex="-1"><a class="header-anchor" href="#安装配置" aria-hidden="true">#</a> 安装配置</h2>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 检查相关依赖，如果没有，安装官方文档进行安装</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><h2 id="功能测试" tabindex="-1"><a class="header-anchor" href="#功能测试" aria-hidden="true">#</a> 功能测试</h2>
...
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/image-20220923155113113.png" alt="image-20220923155113113" loading="lazy"></p>
<p>然后在 longhorn UI 的 settings 页面配置 Backup Target</p>
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/image-20220923155225931.png" alt="image-20220923155225931" loading="lazy"></p>
<blockquote>
<p>⚠️  注意格式，及得在 COS 上提前创建好目录</p>
</blockquote>
<p>校验是否创建成功</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>kubectl -n longhorn-system get backuptargets.longhorn.io
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="其他功能" tabindex="-1"><a class="header-anchor" href="#其他功能" aria-hidden="true">#</a> 其他功能</h3>
...
<li>
<p>CSI 卷快照</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/kubernetes-csi/external-snapshotter
...
<li>
<p>CSI 卷克隆</p>
<p>要求扩展的卷必须处于 <code>detached</code> 状态才能操作</p>
</li>
</ul>
<p>参考链接：</p>
<ul>
