<template><h1 id="性能压测指标及方法" tabindex="-1"><a class="header-anchor" href="#性能压测指标及方法" aria-hidden="true">#</a> 性能压测指标及方法</h1>
<h2 id="一、基础性能测试" tabindex="-1"><a class="header-anchor" href="#一、基础性能测试" aria-hidden="true">#</a> 一、基础性能测试</h2>
<h3 id="cpu-性能" tabindex="-1"><a class="header-anchor" href="#cpu-性能" aria-hidden="true">#</a> CPU 性能</h3>
<h4 id="super-pi" tabindex="-1"><a class="header-anchor" href="#super-pi" aria-hidden="true">#</a> Super_Pi</h4>
<p>在计算性能测试中，我们使用linux下的bc计算器程序通过反正切函数计算5000位圆周率的cpu耗时来对主机进行测试。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 安装 bc</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><h4 id="sysbench-素数计算" tabindex="-1"><a class="header-anchor" href="#sysbench-素数计算" aria-hidden="true">#</a> sysbench 素数计算</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 单线程素数运算，最大素数10000，计算10000 events结束为止</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="内存性能" tabindex="-1"><a class="header-anchor" href="#内存性能" aria-hidden="true">#</a> 内存性能</h3>
<h4 id="内存带宽-stream" tabindex="-1"><a class="header-anchor" href="#内存带宽-stream" aria-hidden="true">#</a> 内存带宽(stream)</h4>
<p>Stream测试是内存测试中业界公认的内存带宽性能测试基准工具</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>yum -y <span class="token function">install</span> gcc gcc-gfortran
...
./stream_c.exe
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><h4 id="内存时延-mlc" tabindex="-1"><a class="header-anchor" href="#内存时延-mlc" aria-hidden="true">#</a> 内存时延(mlc)</h4>
<p>官网下载：https://www.intel.com/content/www/us/en/developer/articles/tool/intelr-memory-latency-checker.html#inpage-nav-9</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">mkdir</span> mlc
<span class="token function">tar</span> -xvf mlc_v3.9a.tgz -C mlc
<span class="token builtin class-name">cd</span> mlc/Linux/
./mlc --latency_matrix
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h4 id="sysbench-连续读写或者随机读写操作" tabindex="-1"><a class="header-anchor" href="#sysbench-连续读写或者随机读写操作" aria-hidden="true">#</a> sysbench 连续读写或者随机读写操作</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 写操作</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><h3 id="磁盘-i-o-性能" tabindex="-1"><a class="header-anchor" href="#磁盘-i-o-性能" aria-hidden="true">#</a> 磁盘 I/O 性能</h3>
<blockquote>
<p>⚠️ 测试时请准备裸的数据盘，测试完成后请重新格式化磁盘</p>
</blockquote>
<h4 id="磁盘读、写iops" tabindex="-1"><a class="header-anchor" href="#磁盘读、写iops" aria-hidden="true">#</a> 磁盘读、写iops</h4>
<p>iops：磁盘的每秒读写次数，这个是随机读写考察的重点</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>yum <span class="token function">install</span> -y fio
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h4 id="磁盘读、写带宽" tabindex="-1"><a class="header-anchor" href="#磁盘读、写带宽" aria-hidden="true">#</a> 磁盘读、写带宽</h4>
<p>bw：磁盘的吞吐量，这个是顺序读写考察的重点</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 顺序读</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h4 id="存储性能——磁盘时延" tabindex="-1"><a class="header-anchor" href="#存储性能——磁盘时延" aria-hidden="true">#</a> 存储性能——磁盘时延</h4>
<p>依据上面结果看 clat</p>
<h3 id="文件-i-o-性能" tabindex="-1"><a class="header-anchor" href="#文件-i-o-性能" aria-hidden="true">#</a> 文件 I/O 性能</h3>
<h4 id="sysbench-文件随机读写速度、顺序读写吞吐率" tabindex="-1"><a class="header-anchor" href="#sysbench-文件随机读写速度、顺序读写吞吐率" aria-hidden="true">#</a> sysbench 文件随机读写速度、顺序读写吞吐率</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 线程数=4 每隔4s输出一次结果 测试时间=60s</span>
...
sysbench --threads<span class="token operator">=</span><span class="token number">4</span> --report-interval<span class="token operator">=</span><span class="token number">4</span> --time<span class="token operator">=</span><span class="token number">60</span> --test<span class="token operator">=</span>fileio --file-num<span class="token operator">=</span><span class="token number">2</span> --file-total-size<span class="token operator">=</span>4G --file-test-mode<span class="token operator">=</span>seqrd run
sysbench --threads<span class="token operator">=</span><span class="token number">4</span> --report-interval<span class="token operator">=</span><span class="token number">4</span> --time<span class="token operator">=</span><span class="token number">60</span> --test<span class="token operator">=</span>fileio --file-num<span class="token operator">=</span><span class="token number">2</span> --file-total-size<span class="token operator">=</span>4G --file-test-mode<span class="token operator">=</span>seqrd cleanup
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><h4 id="dd-顺序写" tabindex="-1"><a class="header-anchor" href="#dd-顺序写" aria-hidden="true">#</a> dd 顺序写</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">dd</span> <span class="token assign-left variable">if</span><span class="token operator">=</span>/dev/zero <span class="token assign-left variable">of</span><span class="token operator">=</span>benchtest_<span class="token variable">$$</span> <span class="token assign-left variable">bs</span><span class="token operator">=</span>512k <span class="token assign-left variable">count</span><span class="token operator">=</span><span class="token number">2048</span> <span class="token assign-left variable">conv</span><span class="token operator">=</span>fdatasync <span class="token operator">&amp;&amp;</span> <span class="token function">rm</span> -f benchtest_<span class="token variable">$$</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="网络性能" tabindex="-1"><a class="header-anchor" href="#网络性能" aria-hidden="true">#</a> 网络性能</h3>
<h4 id="传输速率-pps" tabindex="-1"><a class="header-anchor" href="#传输速率-pps" aria-hidden="true">#</a> 传输速率(pps)</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># server端：</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><h4 id="网络带宽" tabindex="-1"><a class="header-anchor" href="#网络带宽" aria-hidden="true">#</a> 网络带宽</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># server端：</span>
yum <span class="token function">install</span> -y sysstat
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><h4 id="单向时延" tabindex="-1"><a class="header-anchor" href="#单向时延" aria-hidden="true">#</a> 单向时延</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>服务端：
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><h4 id="ping时延" tabindex="-1"><a class="header-anchor" href="#ping时延" aria-hidden="true">#</a> ping时延</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">ping</span> -c <span class="token number">30</span> 同网段其他主机
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h2 id="二、应用性能测试" tabindex="-1"><a class="header-anchor" href="#二、应用性能测试" aria-hidden="true">#</a> 二、应用性能测试</h2>
<h3 id="_1、nginx" tabindex="-1"><a class="header-anchor" href="#_1、nginx" aria-hidden="true">#</a> 1、Nginx</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>wrk:
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>安装
...
prepare
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br></div></div><p>参考：https://blog.csdn.net/aiyowei1106/article/details/117359969</p>
<h3 id="_3、redis" tabindex="-1"><a class="header-anchor" href="#_3、redis" aria-hidden="true">#</a> 3、Redis</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>yum <span class="token function">install</span> -y redis
<span class="token function">service</span> redis start
 
压测：
redis-benchmark -t set,get -n <span class="token number">1000000</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h2 id="三、压测脚本" tabindex="-1"><a class="header-anchor" href="#三、压测脚本" aria-hidden="true">#</a> 三、压测脚本</h2>
<p>压测需要大量采样，并实时观察</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/clay-wangzhi/bench.git
