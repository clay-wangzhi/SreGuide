<template><h1 id="利用lxcfs提升容器资源可见性" tabindex="-1"><a class="header-anchor" href="#利用lxcfs提升容器资源可见性" aria-hidden="true">#</a> 利用LXCFS提升容器资源可见性</h1>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/clay-wangzhi/lxcfs-admission-webhook.git
