<template><h1 id="golang-fmt格式-占位符" tabindex="-1"><a class="header-anchor" href="#golang-fmt格式-占位符" aria-hidden="true">#</a> golang fmt格式“占位符”</h1>
<blockquote>
...
<div class="language-cpp ext-cpp line-numbers-mode"><pre v-pre class="language-cpp"><code># 定义示例类型和变量
