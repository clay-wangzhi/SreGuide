...
<h3 id="字颜色-30—–37" tabindex="-1"><a class="header-anchor" href="#字颜色-30—–37" aria-hidden="true">#</a> 字颜色：30—–37</h3>
...
<h3 id="字背景颜色范围-40—–47" tabindex="-1"><a class="header-anchor" href="#字背景颜色范围-40—–47" aria-hidden="true">#</a> 字背景颜色范围：40—–47</h3>
