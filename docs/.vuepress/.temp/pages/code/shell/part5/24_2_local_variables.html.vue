<template><div><h1 id="_24-2-局部变量" tabindex="-1"><a class="header-anchor" href="#_24-2-局部变量" aria-hidden="true">#</a> 24.2 局部变量</h1>
<p>怎样使一个变量变成“局部”变量？</p>
<p>局部变量
