<template><div><h1 id="第五章-引用" tabindex="-1"><a class="header-anchor" href="#第五章-引用" aria-hidden="true">#</a> 第五章 引用</h1>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>bash$ ls -l [Vv]*
...
<p>可以看到，提示不存在该文件。这里的<code v-pre>'[Vv]*</code>被当成了文件名。
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>bash$ grep '[Ff]irst' *.txt
file1.txt:This is the first line of file1.txt.
file2.txt:This is the First line of file2.txt.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p>在所有.txt文件中找出包含first或者First字符串的行</p>
</blockquote>
<p>注意，不加引号的 <code v-pre>grep [Ff]irst *.txt</code> 在Bash下也同样有效。[^1]</p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>bash$ echo $(ls -l)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>[^1]: 前提是当前目录下有文件名为First或first的文件。这也是使用引用的另一个原因。（感谢 Harald Koenig 指出了这一点）</p>
</div></template>
