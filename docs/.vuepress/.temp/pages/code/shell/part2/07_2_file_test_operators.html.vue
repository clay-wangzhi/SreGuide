<template><div><h1 id="_7-2-文件测试操作" tabindex="-1"><a class="header-anchor" href="#_7-2-文件测试操作" aria-hidden="true">#</a> 7.2 文件测试操作</h1>
...
<p>检测文件是否存在</p>
<p>等价于 <code v-pre>-e</code>。不推荐使用，已被弃用[^1]。</p>
<h3 id="f" tabindex="-1"><a class="header-anchor" href="#f" aria-hidden="true">#</a> -f</h3>
<p>文件是常规文件(regular file)，而非目录或 <a href="http://tldp.org/LDP/abs/html/devref1.html#DEVFILEREF" target="_blank" rel="noopener noreferrer">设备文件<ExternalLinkIcon/></a></p>
...
<p>文件是一个 <a href="http://tldp.org/LDP/abs/html/devref1.html#BLOCKDEVREF" target="_blank" rel="noopener noreferrer">块设备<ExternalLinkIcon/></a></p>
<h3 id="c" tabindex="-1"><a class="header-anchor" href="#c" aria-hidden="true">#</a> -c</h3>
<p>文件是一个 <a href="http://tldp.org/LDP/abs/html/devref1.html#CHARDEVREF" target="_blank" rel="noopener noreferrer">字符设备<ExternalLinkIcon/></a></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">device0</span><span class="token operator">=</span><span class="token string">"/dev/sda2"</span>    <span class="token comment"># /   (根目录)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="p" tabindex="-1"><a class="header-anchor" href="#p" aria-hidden="true">#</a> -p</h3>
<p>文件是一个 <a href="http://tldp.org/LDP/abs/html/special-chars.html#PIPEREF" target="_blank" rel="noopener noreferrer">管道设备<ExternalLinkIcon/></a></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token keyword">function</span> <span class="token function-name function">show_input_type</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="h" tabindex="-1"><a class="header-anchor" href="#h" aria-hidden="true">#</a> -h</h3>
<p>文件是一个 <a href="http://tldp.org/LDP/abs/html/basic.html#SYMLINKREF" target="_blank" rel="noopener noreferrer">符号链接<ExternalLinkIcon/></a></p>
<h3 id="l" tabindex="-1"><a class="header-anchor" href="#l" aria-hidden="true">#</a> -L</h3>
<p>文件是一个符号链接</p>
<h3 id="s-1" tabindex="-1"><a class="header-anchor" href="#s-1" aria-hidden="true">#</a> -S</h3>
<p>文件是一个 <a href="http://tldp.org/LDP/abs/html/devref1.html#SOCKETREF" target="_blank" rel="noopener noreferrer">套接字<ExternalLinkIcon/></a></p>
<h3 id="t" tabindex="-1"><a class="header-anchor" href="#t" aria-hidden="true">#</a> -t</h3>
<p>文件（<a href="http://tldp.org/LDP/abs/html/io-redirection.html#FDREF" target="_blank" rel="noopener noreferrer">文件描述符<ExternalLinkIcon/></a>）与终端设备关联</p>
<p>该选项通常被用于 <a href="http://tldp.org/LDP/abs/html/intandnonint.html#II2TEST" target="_blank" rel="noopener noreferrer">测试<ExternalLinkIcon/></a> 脚本中的 <code v-pre>stdin [ -t 0 ]</code> 或 <code v-pre>stdout [ -t 1 ]</code> 是否为终端设备。</p>
...
<p>文件或目录设置了 set-group-id <code v-pre>sgid</code> 标志</p>
<p>如果一个目录设置了 <code v-pre>sgid</code> 标志，那么在该目录中所有的新建文件的权限组都归属于该目录的权限组，而非文件创建者的权限组。该标志对共享文件夹很有用。</p>
<h3 id="u" tabindex="-1"><a class="header-anchor" href="#u" aria-hidden="true">#</a> -u</h3>
<p>文件设置了 set-user-id <code v-pre>suid</code> 标志。</p>
<p>一个属于 root 的可执行文件设置了 <code v-pre>suid</code> 标志后，即使是一个普通用户执行也拥有 root 权限[^2]。对需要访问硬件设备的可执行文件（例如 <code v-pre>pppd</code> 和 <code v-pre>cdrecord</code>）很有用。如果没有 <code v-pre>suid</code> 标志，这些可执行文件就不能被非 root 用户所调用了。</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>-rwsr-xr-t    1 root       178236 Oct  2  2000 /usr/sbin/pppd
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>设置了 <code v-pre>suid</code> 标志后，在权限中会显示 <code v-pre>s</code>。</p>
<h3 id="k" tabindex="-1"><a class="header-anchor" href="#k" aria-hidden="true">#</a> -k</h3>
<p>设置了粘滞位(sticky bit)。</p>
<p>标志粘滞位是一种特殊的文件权限。如果文件设置了粘滞位，那么该文件将会被存储在高速缓存中以便快速访问[^3]。如果目录设置了该标记，那么它将会对目录的写权限进行限制，目录中只有文件的拥有者可以修改或删除文件。设置标记后你可以在权限中看到 <code v-pre>t</code>。</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>drwxrwxrwt    7 root         1024 May 19 21:26 tmp/
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果一个用户不是设置了粘滞位目录的拥有者，但对该目录有写权限，那么他仅仅可以删除目录中他所拥有的文件。这可以防止用户不经意间删除或修改其他人的文件，例如 <code v-pre>/tmp</code> 文件夹。（当然目录的所有者可以删除或修改该目录下的所有文件）</p>
<h3 id="o" tabindex="-1"><a class="header-anchor" href="#o" aria-hidden="true">#</a> -O</h3>
<p>执行用户是文件的拥有者</p>
<h3 id="g-1" tabindex="-1"><a class="header-anchor" href="#g-1" aria-hidden="true">#</a> -G</h3>
<p>文件的组与执行用户的组相同</p>
<h3 id="n" tabindex="-1"><a class="header-anchor" href="#n" aria-hidden="true">#</a> -N</h3>
<p>文件在在上次访问后被修改过了</p>
<h3 id="f1-nt-f2" tabindex="-1"><a class="header-anchor" href="#f1-nt-f2" aria-hidden="true">#</a> f1 -nt f2</h3>
<p>文件 f1 比文件 f2 新</p>
<h3 id="f1-ot-f2" tabindex="-1"><a class="header-anchor" href="#f1-ot-f2" aria-hidden="true">#</a> f1 -ot f2</h3>
<p>文件 f1 比文件 f2 旧</p>
<h3 id="f1-ef-f2" tabindex="-1"><a class="header-anchor" href="#f1-ef-f2" aria-hidden="true">#</a> f1 -ef f2</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a href="http://tldp.org/LDP/abs/html/zeros.html#COOKIES" target="_blank" rel="noopener noreferrer">样例 31-1<ExternalLinkIcon/></a>，<a href="http://tldp.org/LDP/abs/html/loops1.html#BINGREP" target="_blank" rel="noopener noreferrer">样例 11-8<ExternalLinkIcon/></a>，<a href="http://tldp.org/LDP/abs/html/loops1.html#FILEINFO" target="_blank" rel="noopener noreferrer">样例 11-3<ExternalLinkIcon/></a>，<a href="http://tldp.org/LDP/abs/html/zeros.html#RAMDISK" target="_blank" rel="noopener noreferrer">样例 31-3<ExternalLinkIcon/></a>和<a href="http://tldp.org/LDP/abs/html/contributed-scripts.html#MAILFORMAT" target="_blank" rel="noopener noreferrer">样例 A-1<ExternalLinkIcon/></a> 也包含了测试运算符的使用。</p>
<p>[^1]: 摘自1913年版本的韦氏词典<br><pre>Deprecate<br>...<br><br>To pray against, as an evil;<br>to seek to avert by prayer;<br>to desire the removal of;<br>to seek deliverance from;<br>to express deep regret for;<br>to disapprove of strongly.</pre>
[^2]: 注意使用 suid 的可执行文件可能会带来安全问题。suid 标记对 shell 脚本没有影响。
[^3]: 在 Linux 系统中，文件已经不使用粘滞位了, 粘滞位只作用于目录。</p>
</div></template>
