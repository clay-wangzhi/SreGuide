<template><div><h1 id="_7-4-嵌套-if-then-条件测试" tabindex="-1"><a class="header-anchor" href="#_7-4-嵌套-if-then-条件测试" aria-hidden="true">#</a> 7.4 嵌套 if/then 条件测试</h1>
<p>可以嵌套 <code v-pre>if/then</code> 条件测试结构。嵌套的结果等价于使用 <a href="http://tldp.org/LDP/abs/html/ops.html#LOGOPS1" target="_blank" rel="noopener noreferrer"><code v-pre>&amp;&amp;</code><ExternalLinkIcon/></a> 复合比较运算符。</p>
...
<span class="token keyword">then</span>
  <span class="token builtin class-name">echo</span> <span class="token string">"The value of <span class="token entity" title="\&quot;">\"</span>a<span class="token entity" title="\&quot;">\"</span> lies somewhere between 0 and 5."</span>
<span class="token keyword">fi</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 <a href="http://tldp.org/LDP/abs/html/bashver2.html#CARDS" target="_blank" rel="noopener noreferrer">样例 37-4<ExternalLinkIcon/></a> 和 <a href="http://tldp.org/LDP/abs/html/system.html#BACKLIGHT" target="_blank" rel="noopener noreferrer">样例 17-11<ExternalLinkIcon/></a> 中展示了嵌套 <code v-pre>if/then</code> 条件测试结构。</p>
</div></template>
