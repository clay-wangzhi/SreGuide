<template><div><h1 id="_7-5-牛刀小试" tabindex="-1"><a class="header-anchor" href="#_7-5-牛刀小试" aria-hidden="true">#</a> 7.5 牛刀小试</h1>
<p>系统文件 <code v-pre>xinitrc</code> 可以用来启动软件 X Server。该文件包含了许多 <code v-pre>if/then</code> 测试结构。下面的代码摘录自较早版本的 <code v-pre>xinitrc</code>（大约在 Red Hat 7.1 版本）。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token keyword">if</span> <span class="token punctuation">[</span> <span class="token parameter variable">-f</span> <span class="token environment constant">$HOME</span>/.Xclients <span class="token punctuation">]</span><span class="token punctuation">;</span> <span class="token keyword">then</span>
...
<span class="token keyword">fi</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>试着解释代码片段中的条件测试结构, 然后试着在 /etc/X11/xinit/xinitrc 查看最新版本，并且分析其中的 if/then 条件测试结构。为了更好的进行分析，你可能需要继续阅读后面章节中对 <a href="http://tldp.org/LDP/abs/html/textproc.html#GREPREF" target="_blank" rel="noopener noreferrer"><code v-pre>grep</code><ExternalLinkIcon/></a>，<a href="http://tldp.org/LDP/abs/html/sedawk.html#SEDREF" target="_blank" rel="noopener noreferrer"><code v-pre>sed</code><ExternalLinkIcon/></a> 和 <a href="http://tldp.org/LDP/abs/html/regexp.html#REGEXREF" target="_blank" rel="noopener noreferrer">正则表达式<ExternalLinkIcon/></a> 的讨论。</p>
</div></template>
