<template><div><h1 id="第一章-为什么使用shell编程" tabindex="-1"><a class="header-anchor" href="#第一章-为什么使用shell编程" aria-hidden="true">#</a> 第一章 为什么使用shell编程</h1>
<blockquote>
<p>没有任何一种程序设计语言是完美的，甚至没有一个最好的语言。只有在特定环境下适合的语言。</p>
<p>—— Herbert Mayer</p>
</blockquote>
<p>无论你是否打算真正编写shell脚本，只要你想要在一定程度上熟悉系统管理，了解掌握shell脚本的相关知识都是非常有必要的。例如Linux系统在启动的时候会执行<code v-pre>/etc/rc.d</code>目录下的shell脚本来恢复系统配置和准备服务。详细了解这些启动脚本对分析系统行为大有益处，何况，你很有可能会去修改它们呢。</p>
<p>编写shell脚本并不困难，shell脚本由许多小的部分组成，而其中只有数量相当少的与shell本身特性，操作和选项<a href="%E8%BF%99%E4%BA%9B%E6%93%8D%E4%BD%9C%E5%92%8C%E9%80%89%E9%A1%B9%E8%A2%AB%E7%A7%B0%E4%B8%BA%E5%86%85%E5%BB%BA%E5%91%BD%E4%BB%A4%EF%BC%88builtin%EF%BC%89%EF%BC%8C%E6%98%AFshell%E7%9A%84%E5%86%85%E9%83%A8%E7%89%B9%E5%BE%81%E3%80%82">^1</a>有关的部分才需要去学习。Shell语法非常简单朴素，很像是在命令行中调用和连接工具，你只需遵循很少一部分的&quot;规则&quot;就可以了。大部分短小的脚本通常在第一次就可以正常工作，即使是一个稍长一些的脚本，调试起来也十分简单。</p>
<blockquote>
