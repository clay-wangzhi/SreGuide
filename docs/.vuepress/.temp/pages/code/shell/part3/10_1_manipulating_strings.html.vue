<template><div><h1 id="_10-1-字符串处理" tabindex="-1"><a class="header-anchor" href="#_10-1-字符串处理" aria-hidden="true">#</a> 10.1 字符串处理</h1>
<p>Bash 支持的字符串操作数量达到了一个惊人的数目。但可惜的是，这些操作工具缺乏一个统一的核心。他们中的一些是<a href="http://tldp.org/LDP/abs/html/parameter-substitution.html#PARAMSUBREF" target="_blank" rel="noopener noreferrer">参数代换<ExternalLinkIcon/></a>的子集，另外一些则是 UNIX 下 <a href="http://tldp.org/LDP/abs/html/moreadv.html#EXPRREF" target="_blank" rel="noopener noreferrer"><code v-pre>expr</code><ExternalLinkIcon/></a> 函数的子集。这将会导致语法前后不一致或者功能上出现重叠，更不用说那些可能导致的混乱了。</p>
<h3 id="字符串长度" tabindex="-1"><a class="header-anchor" href="#字符串长度" aria-hidden="true">#</a> 字符串长度</h3>
<h4 id="string" tabindex="-1"><a class="header-anchor" href="#string" aria-hidden="true">#</a> <code v-pre>${#string}</code></h4>
<h4 id="expr-length-string" tabindex="-1"><a class="header-anchor" href="#expr-length-string" aria-hidden="true">#</a> <code v-pre>expr length $string</code></h4>
<p>上面两个表达式等价于C语言中的 <code v-pre>strlen()</code> 函数。</p>
<h4 id="expr-string" tabindex="-1"><a class="header-anchor" href="#expr-string" aria-hidden="true">#</a> <code v-pre>expr &quot;$string&quot; : '.*'</code></h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">stringZ</span><span class="token operator">=</span>abcABC123ABCabc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>样例 10-1. 在文本的段落之间插入空行</p>
...
<h4 id="expr-match-string-substring" tabindex="-1"><a class="header-anchor" href="#expr-match-string-substring" aria-hidden="true">#</a> <code v-pre>expr match &quot;$string&quot; '$substring'</code></h4>
<p>其中，<code v-pre>$substring</code> 是一个<a href="http://tldp.org/LDP/abs/html/regexp.html#REGEXREF" target="_blank" rel="noopener noreferrer">正则表达式<ExternalLinkIcon/></a>。</p>
<h4 id="expr-string-substring" tabindex="-1"><a class="header-anchor" href="#expr-string-substring" aria-hidden="true">#</a> <code v-pre>expr &quot;$string&quot; : '$substring'</code></h4>
<p>其中，<code v-pre>$substring</code> 是一个正则表达式。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="索引" tabindex="-1"><a class="header-anchor" href="#索引" aria-hidden="true">#</a> 索引</h3>
<h4 id="expr-index-string-substring" tabindex="-1"><a class="header-anchor" href="#expr-index-string-substring" aria-hidden="true">#</a> <code v-pre>expr index $string $substring</code></h4>
<p>返回在 <code v-pre>$string</code> 中第一个出现的 <code v-pre>$substring</code> 字符所在的位置。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">stringZ</span><span class="token operator">=</span>abcABC123ABCabc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>几乎等价于C语言中的 <code v-pre>strchr()</code>。</p>
<h3 id="截取字符串-字符串分片" tabindex="-1"><a class="header-anchor" href="#截取字符串-字符串分片" aria-hidden="true">#</a> 截取字符串（字符串分片）</h3>
<h4 id="string-position" tabindex="-1"><a class="header-anchor" href="#string-position" aria-hidden="true">#</a> <code v-pre>${string:position}</code></h4>
<p>在 <code v-pre>$string</code> 中截取自 <code v-pre>$position</code> 起的字符串。</p>
<p>如果参数 <code v-pre>$string</code> 是 &quot;*&quot; 或者 &quot;@&quot;，那么将会截取自 <code v-pre>$position</code> 起的<a href="http://tldp.org/LDP/abs/html/internalvariables.html#POSPARAMREF" target="_blank" rel="noopener noreferrer">位置参数<ExternalLinkIcon/></a>。<a href="%E8%BF%99%E7%A7%8D%E6%83%85%E5%86%B5%E5%90%8C%E6%97%B6%E9%80%82%E7%94%A8%E4%BA%8E%E5%91%BD%E4%BB%A4%E8%A1%8C%E5%8F%82%E6%95%B0%E5%92%8C%E4%BC%A0%E5%85%A5%E5%87%BD%E6%95%B0%E7%9A%84%E5%8F%82%E6%95%B0%E3%80%82">^1</a></p>
<h4 id="string-position-length" tabindex="-1"><a class="header-anchor" href="#string-position-length" aria-hidden="true">#</a> <code v-pre>${string:position:length}</code></h4>
<p>在 <code v-pre>$string</code> 中截取自 <code v-pre>$position</code> 起，长度为 <code v-pre>$length</code> 的字符串。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>
<span class="token assign-left variable">stringZ</span><span class="token operator">=</span>abcABC123ABCabc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其中，参数 <code v-pre>position</code> 与 <code v-pre>length</code> 可以传入一个变量而不一定需要传入常量。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果参数 <code v-pre>$string</code> 是 &quot;*&quot; 或者 &quot;@&quot;，那么将会截取自 <code v-pre>$position</code> 起，最大个数为 <code v-pre>$length</code> 的位置参数。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">echo</span> <span class="token variable">${*<span class="token operator">:</span>2}</span>          <span class="token comment"># 输出第二个及之后的所有位置参数。</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="expr-substr-string-position-length" tabindex="-1"><a class="header-anchor" href="#expr-substr-string-position-length" aria-hidden="true">#</a> <code v-pre>expr substr $string $position $length</code></h4>
<p>在 <code v-pre>$string</code> 中截取自 <code v-pre>$position</code> 起，长度为 <code v-pre>$length</code> 的字符串。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">stringZ</span><span class="token operator">=</span>abcABC123ABCabc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="expr-match-string-substring-1" tabindex="-1"><a class="header-anchor" href="#expr-match-string-substring-1" aria-hidden="true">#</a> <code v-pre>expr match &quot;$string&quot; '\($substring\)'</code></h4>
<p>在 <code v-pre>$string</code> 中截取自 <code v-pre>$position</code> 起的字符串，其中 <code v-pre>$substring</code> 是<a href="http://tldp.org/LDP/abs/html/regexp.html#REGEXREF" target="_blank" rel="noopener noreferrer">正则表达式<ExternalLinkIcon/></a>。</p>
<h4 id="expr-string-substring-1" tabindex="-1"><a class="header-anchor" href="#expr-string-substring-1" aria-hidden="true">#</a> <code v-pre>expr &quot;$string&quot; : '\($substring\)'</code></h4>
<p>在 <code v-pre>$string</code> 中截取自 <code v-pre>$position</code> 起的字符串，其中 <code v-pre>$substring</code> 是正则表达式。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">stringZ</span><span class="token operator">=</span>abcABC123ABCabc
<span class="token comment">#       =======</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="expr-match-string-substring-2" tabindex="-1"><a class="header-anchor" href="#expr-match-string-substring-2" aria-hidden="true">#</a> <code v-pre>expr match &quot;$string&quot; '.*\($substring\)'</code></h4>
<p>从 <code v-pre>$string</code> 结尾部分截取 <code v-pre>$substring</code> 字符串，其中 <code v-pre>$substring</code> 是正则表达式。</p>
<h4 id="expr-string-substring-2" tabindex="-1"><a class="header-anchor" href="#expr-string-substring-2" aria-hidden="true">#</a> <code v-pre>expr &quot;$string&quot; : '.*\($substring\)'</code></h4>
<p>从 <code v-pre>$string</code> 结尾部分截取 <code v-pre>$substring</code> 字符串，其中 <code v-pre>$substring</code> 是正则表达式。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">stringZ</span><span class="token operator">=</span>abcABC123ABCabc
<span class="token comment">#                ======</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="删除子串" tabindex="-1"><a class="header-anchor" href="#删除子串" aria-hidden="true">#</a> 删除子串</h3>
<h4 id="string-substring" tabindex="-1"><a class="header-anchor" href="#string-substring" aria-hidden="true">#</a> <code v-pre>${string#substring}</code></h4>
<p>删除从 <code v-pre>$string</code> 起始部分起，匹配到的最短的 <code v-pre>$substring</code>。</p>
<h4 id="string-substring-1" tabindex="-1"><a class="header-anchor" href="#string-substring-1" aria-hidden="true">#</a> <code v-pre>${string##substring}</code></h4>
<p>删除从 <code v-pre>$string</code> 起始部分起，匹配到的最长的 <code v-pre>$substring</code>。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">stringZ</span><span class="token operator">=</span>abcABC123ABCabc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="string-substring-2" tabindex="-1"><a class="header-anchor" href="#string-substring-2" aria-hidden="true">#</a> <code v-pre>${string%substring}</code></h4>
<p>删除从 <code v-pre>$string</code> 结尾部分起，匹配到的最短的 <code v-pre>$substring</code>。</p>
<p>例如：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 将当前目录下所有后缀名为 "TXT" 的文件改为 "txt" 后缀。</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="string-substring-3" tabindex="-1"><a class="header-anchor" href="#string-substring-3" aria-hidden="true">#</a> <code v-pre>${string%%substring}</code></h4>
<p>删除从 <code v-pre>$string</code> 结尾部分起，匹配到的最长的 <code v-pre>$substring</code>。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>
<span class="token assign-left variable">stringZ</span><span class="token operator">=</span>abcABC123ABCabc
<span class="token comment">#                    ||     最短</span>
<span class="token comment">#        |------------|     最长</span>
...
<span class="token builtin class-name">exit</span> <span class="token variable">$?</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>样例 10-4. 将流音频格式转换成 ogg 格式</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下面是使用字符串截取结构对 <a href="http://tldp.org/LDP/abs/html/extmisc.html#GETOPTY" target="_blank" rel="noopener noreferrer"><code v-pre>getopt</code><ExternalLinkIcon/></a> 的一个简单模拟。</p>
<p>样例 10-5. 模拟 <code v-pre>getopt</code></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="子串替换" tabindex="-1"><a class="header-anchor" href="#子串替换" aria-hidden="true">#</a> 子串替换</h3>
<h4 id="string-substring-replacement" tabindex="-1"><a class="header-anchor" href="#string-substring-replacement" aria-hidden="true">#</a> <code v-pre>${string/substring/replacement}</code></h4>
<p>替换匹配到的第一个 <code v-pre>$substring</code> 为 <code v-pre>$replacement</code>。[^2]</p>
<h4 id="string-substring-replacement-1" tabindex="-1"><a class="header-anchor" href="#string-substring-replacement-1" aria-hidden="true">#</a> <code v-pre>${string//substring/replacement}</code></h4>
<p>替换匹配到的所有 <code v-pre>$substring</code> 为 <code v-pre>$replacement</code>。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">stringZ</span><span class="token operator">=</span>abcABC123ABCabc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="string-substring-replacement-2" tabindex="-1"><a class="header-anchor" href="#string-substring-replacement-2" aria-hidden="true">#</a> <code v-pre>${string/#substring/replacement}</code></h4>
<p>替换 <code v-pre>$string</code> 中最前端匹配到的 <code v-pre>$substring</code> 为 <code v-pre>$replacement</code>。</p>
<h4 id="string-substring-replacement-3" tabindex="-1"><a class="header-anchor" href="#string-substring-replacement-3" aria-hidden="true">#</a> <code v-pre>${string/%substring/replacement}</code></h4>
<p>替换 <code v-pre>$string</code> 中最末端匹配到的 <code v-pre>$substring</code> 为 <code v-pre>$replacement</code>。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">stringZ</span><span class="token operator">=</span>abcABC123ABCabc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>[^2]: 注意根据使用时上下文的不同，<code v-pre>$substring</code> 和 <code v-pre>$replacement</code> 可以是文本字符串也可以是变量。可以参考第一个样例。</p>
</div></template>
