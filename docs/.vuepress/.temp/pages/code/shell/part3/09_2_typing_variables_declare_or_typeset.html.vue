<template><div><h1 id="_9-2-变量类型标注-declare-与-typeset" tabindex="-1"><a class="header-anchor" href="#_9-2-变量类型标注-declare-与-typeset" aria-hidden="true">#</a> 9.2 变量类型标注：<code v-pre>declare</code> 与 <code v-pre>typeset</code></h1>
<p><a href="">内建命令</a> <code v-pre>declare</code> 和 <code v-pre>typeset</code> 是完全相同的命令，其被用于修改变量的属性。相比起一部分编程语言来说，这种修改属于非常弱的类型标注方式[^1]。<code v-pre>declare</code> 命令只有在 Bash version 2 及更高版本才能使用，而 <code v-pre>typeset</code> 命令可以在 ksh 脚本中运行。</p>
<h2 id="declare-typeset-命令选项" tabindex="-1"><a class="header-anchor" href="#declare-typeset-命令选项" aria-hidden="true">#</a> <code v-pre>declare</code>/<code v-pre>typeset</code> 命令选项</h2>
<h3 id="r-只读-readonly" tabindex="-1"><a class="header-anchor" href="#r-只读-readonly" aria-hidden="true">#</a> -r 只读（readonly）</h3>
<p>（<code v-pre>declare -r var1</code> 与 <code v-pre>readonly var1</code> 的作用相同）</p>
<p>该选项约等于 C 语言中的类型限定符 <code v-pre>const</code>。任何尝试修改只读变量的行为都会导致脚本出错。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">declare</span> <span class="token parameter variable">-r</span> <span class="token assign-left variable">var1</span><span class="token operator">=</span><span class="token number">1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="i-整型-integer" tabindex="-1"><a class="header-anchor" href="#i-整型-integer" aria-hidden="true">#</a> -i 整型（integer）</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">declare</span> <span class="token parameter variable">-i</span> number
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>被视为整型的变量无需命令 <a href=""><code v-pre>expr</code></a> 或是 <a href=""><code v-pre>let</code></a> 即可进行数学运算。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">n</span><span class="token operator">=</span><span class="token number">6</span>/3
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="a-数组-array" tabindex="-1"><a class="header-anchor" href="#a-数组-array" aria-hidden="true">#</a> -a 数组（array）</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">declare</span> <span class="token parameter variable">-a</span> indices
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>变量 <code v-pre>indices</code> 会被视作 <a href="">数组</a>。</p>
<h3 id="f-函数-function" tabindex="-1"><a class="header-anchor" href="#f-函数-function" aria-hidden="true">#</a> -f 函数（function）</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">declare</span> <span class="token parameter variable">-f</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果没有在 <code v-pre>declare -f</code> 后带上任何参数，该语句将会列出在脚本中已经定义的所有函数。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">declare</span> <span class="token parameter variable">-f</span> function_name
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>而 <code v-pre>declare -f function_name</code> 则仅仅列出名为 <code v-pre>function_name</code> 的函数。</p>
<h3 id="x-导出-export" tabindex="-1"><a class="header-anchor" href="#x-导出-export" aria-hidden="true">#</a> -x 导出（export）</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">declare</span> <span class="token parameter variable">-x</span> var3
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>该语句声明了变量 <code v-pre>var3</code> 可以导出到该变量所属脚本之外的 shell 环境中。</p>
<h3 id="x-var-value" tabindex="-1"><a class="header-anchor" href="#x-var-value" aria-hidden="true">#</a> -x var=$value</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">declare</span> <span class="token parameter variable">-x</span> <span class="token assign-left variable">var3</span><span class="token operator">=</span><span class="token number">373</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code v-pre>declare</code> 命令允许在设置变量属性的同时给变量赋值。</p>
<h4 id="样例9-10-使用-declare-命令标注变量类型" tabindex="-1"><a class="header-anchor" href="#样例9-10-使用-declare-命令标注变量类型" aria-hidden="true">#</a> 样例9-10. 使用 <code v-pre>declare</code> 命令标注变量类型</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>{% hint style=&quot;warning&quot; %}</p>
<p>使用内建命令 <code v-pre>declare</code> 还可以限制变量的 <a href="">作用域</a>。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function-name function">foo</span> <span class="token punctuation">(</span><span class="token punctuation">)</span>
<span class="token punctuation">{</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function-name function">foo</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<p>{% hint style=&quot;info&quot; %}
在本书中，变量类型标注（typing）是指指定变量类型并限制其属性。例如一个变量被 <code v-pre>declared</code> 或是 <code v-pre>typed</code> 命令声明为整型，则该变量不再适用于各种 <a href="">字符串操作</a>。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">declare</span> <span class="token parameter variable">-i</span> intvar
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>{% endhint %}</p>
<p>[^1]: Footnotes placeholder</p>
</div></template>
