...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>命令的输出可以作为另一个命令的参数，也可以赋值给一个变量。甚至在 <a href="http://tldp.org/LDP/abs/html/loops1.html#FORLOOPREF1" target="_blank" rel="noopener noreferrer"><code v-pre>for</code><ExternalLinkIcon/></a> 循环中可以用输出产生参数表。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">rm</span> <span class="token variable"><span class="token variable">`</span><span class="token function">cat</span> filename<span class="token variable">`</span></span>   <span class="token comment"># "filename" 中包含了一系列需要被删除的文件名。</span>
...
<p><img src="http://tldp.org/LDP/abs/images/note.gif" alt="note"> 命令替换本质上是调用了一个 <a href="http://tldp.org/LDP/abs/html/subshells.html#SUBSHELLSREF" target="_blank" rel="noopener noreferrer">子进程<ExternalLinkIcon/></a> 来执行。</p>
</blockquote>
<blockquote>
<p><img src="http://tldp.org/LDP/abs/images/caution.gif" alt="caution"> 命令替换有可能会出现 <a href="http://tldp.org/LDP/abs/html/quotingvar.html#WSPLITREF" target="_blank" rel="noopener noreferrer">字符分割<ExternalLinkIcon/></a> 的情况。</p>
</blockquote>
<blockquote>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>COMMAND <span class="token variable"><span class="token variable">`</span><span class="token builtin class-name">echo</span> a b<span class="token variable">`</span></span>     <span class="token comment"># 2个参数：a和b</span>
...
<blockquote>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># cd "`pwd`"  # 你是不是认为这条语句在任何情况下都不会出现错误？</span>
...
<blockquote>
<p><img src="http://tldp.org/LDP/abs/images/caution.gif" alt="caution"> 使用 <code v-pre>echo</code> 输出未被引用的命令代换的变量时会删掉尾部的换行。这可能会导致非常不好的情况出现。</p>
</blockquote>
<blockquote>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">dir_listing</span><span class="token operator">=</span><span class="token variable"><span class="token variable">`</span><span class="token function">ls</span> <span class="token parameter variable">-l</span><span class="token variable">`</span></span>
...
<p>你甚至可以使用 <a href="http://tldp.org/LDP/abs/html/io-redirection.html#IOREDIRREF" target="_blank" rel="noopener noreferrer">重定向<ExternalLinkIcon/></a> 或者 <a href="http://tldp.org/LDP/abs/html/basic.html#CATREF" target="_blank" rel="noopener noreferrer"><code v-pre>cat</code><ExternalLinkIcon/></a> 命令把一个文件的内容通过命令代换赋值给一个变量。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">variable1</span><span class="token operator">=</span><span class="token variable"><span class="token variable">`</span><span class="token operator">&lt;</span>file1<span class="token variable">`</span></span>      <span class="token comment"># 将 "file1" 的内容赋值给 variable1。</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#  摘录自系统文件 /etc/rc.d/rc.sysinit</span>
...
<p>命令替换允许将 <a href="http://tldp.org/LDP/abs/html/loops1.html#FORLOOPREF1" target="_blank" rel="noopener noreferrer">循环<ExternalLinkIcon/></a> 的输出结果赋值给一个变量。这其中的关键在于循环内部的 <a href="http://tldp.org/LDP/abs/html/internal.html#ECHOREF" target="_blank" rel="noopener noreferrer"><code v-pre>echo</code><ExternalLinkIcon/></a> 命令。</p>
...
<p>命令替换能够让 Bash 做更多的事情。而这仅仅需要在书写程序或者脚本时将结果输出到标准输出 <code v-pre>stdout</code> 中，然后将这些输出结果赋值给变量即可。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>bash$ gcc -0 hello hello.c
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>bash$ sh hello.sh
Hello, world.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></blockquote>
<blockquote>
<p><img src="http://tldp.org/LDP/abs/images/note.gif" alt="note"> 在命令替换中，你可以使用 <code v-pre>$(...)</code> 来替代反引号。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">output</span><span class="token operator">=</span><span class="token variable"><span class="token variable">$(</span><span class="token function">sed</span> <span class="token parameter variable">-n</span> /<span class="token string">"<span class="token variable">$1</span>"</span>/p $file<span class="token variable">)</span></span>   <span class="token comment"># 摘自 "grp.sh"。</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>$(...)</code> 和反引号在处理双反斜杠上有所不同。</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>bash$ echo `echo \\`


bash$ echo $(echo \\)
\
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>$(...)</code> 允许嵌套。[^3]</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">word_count</span><span class="token operator">=</span><span class="token variable"><span class="token variable">$(</span> <span class="token function">wc</span> <span class="token parameter variable">-w</span> <span class="token punctuation">$(</span>echo * <span class="token operator">|</span> <span class="token function">awk</span> <span class="token string">'{print $8}'</span><span class="token punctuation">)</span> <span class="token variable">)</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>样例 12-3. 寻找变位词（anagram）</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<p>[^1]: 在命令替换中可以使用外部系统命令，<a href="http://tldp.org/LDP/abs/html/internal.html#BUILTINREF" target="_blank" rel="noopener noreferrer">内建命令<ExternalLinkIcon/></a> 甚至是 <a href="http://tldp.org/LDP/abs/html/assortedtips.html#RVT" target="_blank" rel="noopener noreferrer">脚本函数<ExternalLinkIcon/></a>。</p>
<p>[^3]: 事实上，使用反引号进行嵌套也是可行的。但是 John Default 提醒到需要将内部的反引号进行转义。<pre>word_count=` wc -w \`echo * | awk '{print $8}'\` `</pre></p>
</div></template>
