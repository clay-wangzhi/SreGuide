<template><div><h1 id="_9-1-内部变量" tabindex="-1"><a class="header-anchor" href="#_9-1-内部变量" aria-hidden="true">#</a> 9.1 内部变量</h1>
...
<p>Bash程序的路径。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$BASH</span>
/bin/bash
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="bash-env" tabindex="-1"><a class="header-anchor" href="#bash-env" aria-hidden="true">#</a> $BASH_ENV</h3>
...
<p>当前 Bash 进程实例的进程ID号。虽然与 <code v-pre>$$</code> 变量不一样，但是通常它们会给出相同的结果。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash4$ <span class="token builtin class-name">echo</span> <span class="token variable">$$</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash4</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="bash-versinfo-n" tabindex="-1"><a class="header-anchor" href="#bash-versinfo-n" aria-hidden="true">#</a> $BASH_VERSINFO[n]</h3>
<p>这是一个6个元素的数组，其中包含了已经安装的 Bash 的版本信息。该变量与变量 <code v-pre>$BASH_VERSION</code> 类似，但是更加详细。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># Bash 版本信息：</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="bash-version" tabindex="-1"><a class="header-anchor" href="#bash-version" aria-hidden="true">#</a> $BASH_VERSION</h3>
<p>已经安装的 Bash 的版本信息。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$BASH_VERSION</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>tcsh% <span class="token builtin class-name">echo</span> <span class="token environment constant">$BASH_VERSION</span>
<span class="token environment constant">BASH_VERSION</span><span class="token builtin class-name">:</span> Undefined variable.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>利用 <code v-pre>$BASH_VERSION</code> 来判断运行的是哪个 shell 是一个不错的方法，因为变量 <code v-pre>$SHELL</code> 并不总是能够给出正确的答案。</p>
<h3 id="cdpath" tabindex="-1"><a class="header-anchor" href="#cdpath" aria-hidden="true">#</a> $CDPATH</h3>
<p>变量指定 <code v-pre>cd</code> 命令可以搜索的路径，路径之间用冒号进行分隔。该变量的功能类似于指定可执行文件搜索路径的变量 <code v-pre>$PATH</code>。可以在本地文件 <code v-pre>~/.bashrc</code> 中设置该变量。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">cd</span> bash-doc
...
/usr/share/doc/bash-doc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="dirstack" tabindex="-1"><a class="header-anchor" href="#dirstack" aria-hidden="true">#</a> $DIRSTACK</h3>
<p>指代目录栈中顶部的值[^1]，目录栈由命令 <code v-pre>pushd</code> 和 <code v-pre>popd</code> 控制。</p>
<p>该变量相当于命令 <code v-pre>dirs</code>，但是 <code v-pre>dirs</code> 命令会显示整个目录栈。</p>
<h3 id="editor" tabindex="-1"><a class="header-anchor" href="#editor" aria-hidden="true">#</a> $EDITOR</h3>
<p>脚本所调用的默认编辑器，通常是 <code v-pre>vi</code> 或是 <code v-pre>emcas</code>。</p>
<h3 id="euid" tabindex="-1"><a class="header-anchor" href="#euid" aria-hidden="true">#</a> $EUID</h3>
<p>有效用户ID。</p>
<p>有效用户ID（EUID）是指当前用户正在使用的用户ID，可以通过 <code v-pre>su</code> 命令修改。</p>
<p>{% hint style=&quot;warning&quot; %}</p>
<p><code v-pre>$EUID</code> 与 <code v-pre>$UID</code> 并不总是相同的。</p>
<p>{% endhint %}</p>
<h3 id="funcname" tabindex="-1"><a class="header-anchor" href="#funcname" aria-hidden="true">#</a> $FUNCNAME</h3>
<p>当前运行函数的函数名。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function-name function">xyz23</span> <span class="token punctuation">(</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以参考 <a href="">样例 A-50</a>。</p>
...
<p>当前用户所属的用户组。</p>
<p>该变量存储了当前用户所归属的用户组ID列表，是一个数组。内容与记录在文件 <code v-pre>/etc/passwd</code> 和文件 <code v-pre>/etc/group</code> 中的一致。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>root<span class="token comment"># echo $GROUPS</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="home" tabindex="-1"><a class="header-anchor" href="#home" aria-hidden="true">#</a> $HOME</h3>
<p>当前用户的主目录，其值通常为 <code v-pre>/home/username</code> （参考 <a href="">样例 10-7</a>）。</p>
<h3 id="homename" tabindex="-1"><a class="header-anchor" href="#homename" aria-hidden="true">#</a> $HOMENAME</h3>
<p>系统启动的初始化脚本通过命令 <code v-pre>hostname</code> 给系统分配主机名。而函数 <code v-pre>gethostname()</code> 则是给 Bash 的内部变量 <code v-pre>$HOSTNAME</code> 赋值。可以参考 <a href="">样例 10-7</a>。</p>
<h3 id="hosttype" tabindex="-1"><a class="header-anchor" href="#hosttype" aria-hidden="true">#</a> $HOSTTYPE</h3>
<p>主机类型。</p>
<p>类似变量 <a href=""><code v-pre>$MACHTYPE</code></a>，用于识别系统硬件信息。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$HOSTTYPE</span>
i686
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="ifs" tabindex="-1"><a class="header-anchor" href="#ifs" aria-hidden="true">#</a> $IFS</h3>
<p>内部字段分隔符。</p>
<p>该变量决定了 Bash 在解析字符串时如何去识别 <a href="">字段</a> 或单词边界。</p>
<p><code v-pre>$IFS</code> 的缺省值是空白符（空格，制表符以及换行符），但其可以被修改。例如你在处理逗号分隔的文件时可以将其设置为逗号。需要注意 <a href=""><code v-pre>$*</code></a> 使用保存在 <code v-pre>$IFS</code> 中的第一个字符。可以参考 <a href="">样例 5-1</a>。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token string">"<span class="token environment constant">$IFS</span>"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过设置 <code v-pre>$IFS</code> 来忽略文件路径名中空格带来的影响。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable"><span class="token environment constant">IFS</span></span><span class="token operator">=</span><span class="token string">"<span class="token variable"><span class="token variable">$(</span><span class="token builtin class-name">printf</span> <span class="token string">'\n\t'</span><span class="token variable">)</span></span>"</span>   <span class="token comment"># 按 David Wheeler 所述。</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>{% hint style=&quot;warning&quot; %}</p>
<p>相比于其他字符，变量 <code v-pre>$IFS</code> 在处理空白符时有所不同。</p>
...
<p>也可以参考 <a href="">样例 16-41</a>，<a href="">样例 11-8</a> 和 <a href="">样例19-14</a>，获取更多使用 <code v-pre>$IFS</code> 的技巧。</p>
...
<p>经常会在文件 <a href=""><code v-pre>.bashrc</code></a> 或是文件 <code v-pre>/etc/profile</code> 中被设置。该变量控制文件名扩展和模式匹配中的排序顺序。如果设置不得当，<code v-pre>LC_COLLATE</code> 将会导致 <a href="">文件名匹配</a> 中出现非预期结果。</p>
<p>{% hint style=&quot;info&quot; %}</p>
<p>在 Bash 2.05 版本之后，文件名匹配在不再区分中括号中字母的大小写。例如 <code v-pre>ls [A-M]*</code> 将会同时匹配 <code v-pre>File1.txt</code> 和 <code v-pre>file1.txt</code> 两个文件。如果想要恢复成之前的模式，则需要在文件 <code v-pre>/etc/profile</code> 或文件 <code v-pre>~/.bashrc</code> 中通过语句 <code v-pre>export LC_COLLATE=C</code> 设置 <code v-pre>LC_COLLATE</code> 的值为 <code v-pre>C</code>。</p>
<p>{% endhint %}</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># *** 调试部分起始 ***</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="machtype" tabindex="-1"><a class="header-anchor" href="#machtype" aria-hidden="true">#</a> $MACHTYPE</h3>
<p>设备类型。</p>
<p>识别系统硬件。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$MACHTYPE</span>
i686
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="oldpwd" tabindex="-1"><a class="header-anchor" href="#oldpwd" aria-hidden="true">#</a> $OLDPWD</h3>
...
<p>操作系统类型。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$OSTYPE</span>
linux
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="path" tabindex="-1"><a class="header-anchor" href="#path" aria-hidden="true">#</a> $PATH</h3>
<p>可执行文件搜索路径，其值通常包含 <code v-pre>/usr/bin</code>，<code v-pre>/usr/X11R6/bin/</code>，<code v-pre>/usr/local/bin</code> 等路径。</p>
<p>给定一个命令，shell就会自动从搜索路径包含的目录中利用哈希表搜索该可执行命令。而搜索路径就保存在 <a href="">环境变量</a> <code v-pre>$PATH</code> 中，其中包含的一系列目录则通过冒号进行分隔。通常情况下，<code v-pre>$PATH</code> 会定义在文件 <code v-pre>/etc/profile</code> 或文件 <a href=""><code v-pre>~/.bashrc</code></a> 中（参考 <a href="">附录 H</a>）。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$PATH</span>
/bin:/usr/bin:/usr/local/bin/:/usr/X11R6/bin:/sbin:/usr/sbin
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>PATH=${PATH}:/opt/bin</code> 表示添加目录 <code v-pre>/opt/bin</code> 到当前的搜索路径中。在脚本中可以通过这种方式临时添加目录到搜索路径。而当脚本结束时，<code v-pre>$PATH</code> 就会恢复到原始值（类似于脚本这样的子进程所作出的修改，不会影响到例如 shell 这样的父进程的环境）。</p>
<p>{% hint style=&quot;info&quot; %}</p>
<p>基于安全考虑，通常在 <code v-pre>$PATH</code> 中会省略当前工作目录 <code v-pre>./</code>。</p>
<p>{% endhint %}</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$PIPESTATUS</span>
<span class="token number">0</span>
...
<span class="token number">127</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>$PIPESTATUS</code> 数组中的每一个元素都代表了该管道中相对应命令的退出状态。<code v-pre>$PIPESTATUS[0]</code> 表示管道中第一个命令的退出状态，<code v-pre>$PIPESTATUS[1]</code> 表示第二个命令的退出状态，以此类推。</p>
<p>{% hint style=&quot;warning&quot; %}</p>
<p>在Bash 3.0 以下版本的登录shell中，变量 <code v-pre>$PIPESTATUS</code> 可能会包含一个不正确的 0 值。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>tcsh% <span class="token function">bash</span>
...
<span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果脚本包含了上述代码，应该得到期望的输出是 0 1 0。</p>
<p>感谢 Wayne Pollock 指出了这个问题并提供了上述的样例。</p>
<p>{% endhint %}</p>
<p>{% hint style=&quot;info&quot; %}</p>
<p>在某些场景下，<code v-pre>$PIPESTATUS</code> 变量将会产生非预期结果。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$BASH_VERSION</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Chet Ramey 把上述非预期结果的原因归咎于 <a href=""><code v-pre>ls</code></a> 命令的行为。如果 <code v-pre>ls</code> 将结果输出到没有被读取的管道上，产生的 SIGPIPE 信号将会终止 <code v-pre>ls</code> 命令，同时其 <a href="">退出状态</a> 从期望的 0 变为 141。而同样的情况也会发生在命令 <code v-pre>tr</code> 中。</p>
<p>{% endhint %}</p>
<p>{% hint style=&quot;info&quot; %}</p>
<p><code v-pre>$PIPESTATUS</code> 是一个易失的变量。该变量需要在目标管道执行完成后，且其他任何命令执行之前去捕获。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash$ <span class="token function">ls</span> <span class="token operator">|</span> bogus_command <span class="token operator">|</span> <span class="token function">wc</span>
bash: bogus_command: <span class="token builtin class-name">command</span> not found
 <span class="token number">0</span>       <span class="token number">0</span>                <span class="token number">0</span>
...
<p>{% hint style=&quot;info&quot; %}</p>
<p>在 <code v-pre>$PIPESTATUS</code> 不能给出所期望的信息的情况下，使用 <a href="">pipeline 选项</a> 可能会有帮助。</p>
<p>{% endhint %}</p>
<h3 id="ppid" tabindex="-1"><a class="header-anchor" href="#ppid" aria-hidden="true">#</a> $PPID</h3>
<p>一个进程的 <code v-pre>$PPID</code> 即该进程的父进程的进程ID(pid)。[^2]</p>
<p>可以与命令 <a href=""><code v-pre>pidof</code></a> 进行比较。</p>
<h3 id="prompt-command" tabindex="-1"><a class="header-anchor" href="#prompt-command" aria-hidden="true">#</a> $PROMPT_COMMAND</h3>
<p>该变量存储在主提示符 <code v-pre>$PS1</code> 显示之前所需要执行的命令。</p>
...
<p>次要提示符，当需要额外输入时出现的提示符。默认显示为 <code v-pre>&gt;</code>。</p>
<h3 id="ps3" tabindex="-1"><a class="header-anchor" href="#ps3" aria-hidden="true">#</a> $PS3</h3>
<p>三级提示符，显示在 <code v-pre>select</code> 循环中（参考 <a href="">样例 11-30</a>）。</p>
<h3 id="ps4" tabindex="-1"><a class="header-anchor" href="#ps4" aria-hidden="true">#</a> $PS4</h3>
<p>四级提示符，当使用 <code v-pre>-x [verbose trace]</code> <a href="">选项</a> 调用脚本时显示的提示符。默认显示为 <code v-pre>+</code>。</p>
<p>其可以作为调试的辅助手段，把一些诊断信息显示在 <code v-pre>$PS4</code> 中可能会有帮助。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable"><span class="token environment constant">PS4</span></span><span class="token operator">=</span><span class="token string">'$(read time junk &lt; /proc/$$/schedstat; echo "@@@ $time @@@ " )'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="pwd" tabindex="-1"><a class="header-anchor" href="#pwd" aria-hidden="true">#</a> $PWD</h3>
<p>工作目录（你当前所在的目录）。</p>
<p>该变量是内建命令 <a href=""><code v-pre>pwd</code></a> 的翻版。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<p>当没有给 <a href=""><code v-pre>read</code></a> 命令提供接收参数时的默认接收参数。该变量同样适用于 <a href=""><code v-pre>select</code></a> 菜单接收用户输入值的场景，需要注意的是，用户只需要输入菜单项的编号，而不需要输入完整的菜单项内容。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<span class="token builtin class-name">exit</span> <span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="shellopts" tabindex="-1"><a class="header-anchor" href="#shellopts" aria-hidden="true">#</a> $SHELLOPTS</h3>
<p>该只读变量记录了 shell 中已启用的 <a href="">选项</a> 列表。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$SHELLOPTS</span>
braceexpand:hashall:histexpand:monitor:history:interactive-comments:emacs
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="shlvl" tabindex="-1"><a class="header-anchor" href="#shlvl" aria-hidden="true">#</a> $SHLVL</h3>
<p>当前 shell 的层级，即嵌套了多少层 Bash [^3]。如果命令行的层级 <code v-pre>$SHLVL</code> 为 1，那么在其中执行的脚本层级则增加到 2。</p>
<p>{% hint style=&quot;info&quot; %}</p>
<p>该变量 <a href="">不受 subshell 影响</a>。当你需要指出嵌套了多少层 subshell 时，需要使用变量 <a href="#$BASH_SUBSHELL"><code v-pre>$BASH_SUBSHELL</code></a>。</p>
<p>{% endhint %}</p>
<h3 id="tmout" tabindex="-1"><a class="header-anchor" href="#tmout" aria-hidden="true">#</a> $TMOUT</h3>
<p>如果 <code v-pre>$TMOUT</code> 被设为非 0 值 <code v-pre>time</code>，那么 shell 会在 <code v-pre>$time</code> 秒后超时，然后导致 shell 登出。</p>
<p>在 Bash 2.05b 版本之后，可以在脚本中将 <code v-pre>read</code> 命令与 <code v-pre>$TMOUT</code> 变量进行结合。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 只能在 Bash 2.05b 及之后的版本中成功执行。</span>
...
<span class="token builtin class-name">exit</span> <span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>还有一种方法是使用 <a href=""><code v-pre>stty</code></a>。</p>
...
<span class="token builtin class-name">exit</span> <span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可能最简单的方法就是利用 <a href=""><code v-pre>read</code></a> 命令的 <code v-pre>-t</code> 选项。</p>
...
<p>用户 ID。</p>
<p>记录在文件 <a href=""><code v-pre>/etc/passwd</code></a> 中当前用户的用户标识号。</p>
<p>该 ID 表示的是当前用户的真实 ID，即使用户通过 <code v-pre>su</code> 命令临时切换至另一个用户，这个 ID 也不会改变。<code v-pre>$UID</code> 是一个只读变量，不能够被命令行或是脚本中的命令所修改，并与内建命令 <a href=""><code v-pre>id</code></a> 相对应。</p>
...
<p>{% hint style=&quot;info&quot; %}</p>
<p>变量 <code v-pre>$ENV</code>，<code v-pre>$LOGNAME</code>，<code v-pre>$MAIL</code>，<code v-pre>$TERM</code>，<code v-pre>$USER</code> 以及 <code v-pre>$USERNAME</code> 并不是 Bash 的 <a href="">内建变量</a>，而是在 <a href=""><code v-pre>Bash</code></a> 或系统的某个启动文件中，被设置而成的 <a href="">环境变量</a>。代表当前用户登录 shell 名称的变量 <code v-pre>$SHELL</code> 是在文件 <code v-pre>/etc/password</code> 或是某个初始化脚本中被设定的，它也不是一个 Bash 的内建变量。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>tcsh% <span class="token builtin class-name">echo</span> <span class="token environment constant">$LOGNAME</span>
bozo
...
<p>位置参数。出现在从命令行传递给脚本、函数或是通过内建命令 <a href=""><code v-pre>set</code></a> 设置变量时（参考 <a href="">样例 4-5</a> 或是 <a href="">样例 15-16</a>）。</p>
<h3 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a> $#</h3>
<p>命令行参数[^4]或是位置参数的个数（参考 <a href="">样例 36-2</a>）。</p>
<h3 id="-1" tabindex="-1"><a class="header-anchor" href="#-1" aria-hidden="true">#</a> $*</h3>
<p>将所有的位置参数整合，视作一个单词。</p>
<p>{% hint style=&quot;info&quot; %}</p>
<p>该参数必须是被引用的状态，<code v-pre>&quot;$*&quot;</code>。</p>
<p>{% endhint %}</p>
<h3 id="-2" tabindex="-1"><a class="header-anchor" href="#-2" aria-hidden="true">#</a> $@</h3>
<p>该参数等同于 <code v-pre>$*</code>，但其中每个参数都是独立的被引用的字符串。也就是说，所有的参数都是被原封不动的进行传递，并没有被解析或是扩展。这意味着，参数列表中的每一个参数都被独立视为一个单词。</p>
<p>{% hint style=&quot;info&quot; %}</p>
<p>同样，该参数必须是被引用的状态，<code v-pre>&quot;$@&quot;</code>。</p>
<p>{% endhint %}</p>
...
<span class="token builtin class-name">exit</span> <span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 <code v-pre>shift</code> 命令执行后，<code v-pre>$@</code> 将会保留除了 <code v-pre>$1</code> 之外的剩余的命令行参数，而 <code v-pre>$1</code> 则会被丢弃。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>参数 <code v-pre>$@</code> 也可被用作过滤 shell 脚本输入的工具。结构 <code v-pre>cat &quot;$@&quot;</code> 可以接受来自标准输入 <code v-pre>stdin</code> 的输入，也可以接受传递给脚本的参数中的文件中的输入。参考 <a href="">样例 16-24</a> 和 <a href="">样例 16-25</a>。</p>
<p>{% hint style=&quot;warning&quot; %}</p>
<p>根据分隔符 <a href=""><code v-pre>$IFS</code></a> 设置的不同，<code v-pre>$*</code> 和 <code v-pre>$@</code> 有时会出现不一致或非预期行为。</p>
<p>{% endhint %}</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>{% hint style=&quot;info&quot; %}</p>
<p><code v-pre>$@</code> 和 <code v-pre>$*</code> 仅在被双引号引用时才会表现出不同。</p>
<p>{% endhint %}</p>
...
<p>使用 <a href=""><code v-pre>set</code></a> 命令设置的脚本标记。参考 <a href="">样例 15-16</a>。</p>
<p>{% hint style=&quot;warning&quot; %}</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">LOG</span><span class="token operator">=</span><span class="token variable">$0</span>.log
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>也可以这么使用：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 该样例由 Matthew Sage 编写。</span>
...
<span class="token builtin class-name">exit</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="-5" tabindex="-1"><a class="header-anchor" href="#-5" aria-hidden="true">#</a> $_</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="-6" tabindex="-1"><a class="header-anchor" href="#-6" aria-hidden="true">#</a> $?</h3>
...
<p>脚本自身的进程 ID[^5]。该变量 <code v-pre>$$</code> 通常在脚本构建独有的临时文件时被使用（参考 <a href="">样例 32-6</a>，<a href="">样例 16-31</a>，以及 <a href="">样例 15-27</a>）。该方法通常比调用 <a href=""><code v-pre>mktemp</code></a> 命令更简单。</p>
...
{% endhint %}</p>
<p>{% hint style=&quot;info&quot; %}
当前运行脚本的进程 ID 就是 <code v-pre>$$</code>。
{% endhint %}</p>
<p>{% hint style=&quot;info&quot; %}
...
{% endhint %}</p>
<p>{% hint style=&quot;info&quot; %}
在 subshell 中运行的脚本，<code v-pre>$$</code> <a href="">返回脚本的进程 ID</a> 而非 subshell 的。
{% endhint %}</p>
<p>[^1]: Footnotes placeholder
[^2]: Footnotes placeholder
[^3]: Footnotes placeholder
[^4]: Footnotes placeholder
[^5]: Footnotes placeholder</p>
</div></template>
