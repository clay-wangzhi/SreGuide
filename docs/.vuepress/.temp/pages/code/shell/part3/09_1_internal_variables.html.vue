<template><h1 id="_9-1-内部变量" tabindex="-1"><a class="header-anchor" href="#_9-1-内部变量" aria-hidden="true">#</a> 9.1 内部变量</h1>
<h2 id="内建变量" tabindex="-1"><a class="header-anchor" href="#内建变量" aria-hidden="true">#</a> 内建变量</h2>
<p>影响 Bash 脚本行为的变量。</p>
<h3 id="bash" tabindex="-1"><a class="header-anchor" href="#bash" aria-hidden="true">#</a> $BASH</h3>
<p>Bash程序的路径。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$BASH</span>
/bin/bash
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="bash-env" tabindex="-1"><a class="header-anchor" href="#bash-env" aria-hidden="true">#</a> $BASH_ENV</h3>
<p>这个环境变量会指向一个 Bash 启动文件，该文件在脚本被调用时会被读取。</p>
<h3 id="bash-subshell" tabindex="-1"><a class="header-anchor" href="#bash-subshell" aria-hidden="true">#</a> $BASH_SUBSHELL</h3>
<p>该变量用于提示所处的 subshell 层级。这是在 Bash version 3 中被引入的新特性。</p>
<p>具体用法可以参考 <a href="http://tldp.org/LDP/abs/html/subshells.html#SUBSHELL" target="_blank" rel="noopener noreferrer">样例21-1<ExternalLinkIcon/></a>。</p>
<h3 id="bashpid" tabindex="-1"><a class="header-anchor" href="#bashpid" aria-hidden="true">#</a> $BASHPID</h3>
<p>当前 Bash 进程实例的进程ID号。虽然与 <code>$$</code> 变量不一样，但是通常它们会给出相同的结果。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>bash4$ <span class="token builtin class-name">echo</span> <span class="token variable">$$</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>然而...</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash4</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><h3 id="bash-versinfo-n" tabindex="-1"><a class="header-anchor" href="#bash-versinfo-n" aria-hidden="true">#</a> $BASH_VERSINFO[n]</h3>
<p>这是一个6个元素的数组，其中包含了已经安装的 Bash 的版本信息。该变量与变量 <code>$BASH_VERSION</code> 类似，但是更加详细。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># Bash 版本信息：</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><h3 id="bash-version" tabindex="-1"><a class="header-anchor" href="#bash-version" aria-hidden="true">#</a> $BASH_VERSION</h3>
<p>已经安装的 Bash 的版本信息。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$BASH_VERSION</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>tcsh% <span class="token builtin class-name">echo</span> <span class="token environment constant">$BASH_VERSION</span>
<span class="token environment constant">BASH_VERSION</span><span class="token builtin class-name">:</span> Undefined variable.
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>利用 <code>$BASH_VERSION</code> 来判断运行的是哪个 shell 是一个不错的方法，因为变量 <code>$SHELL</code> 并不总是能够给出正确的答案。</p>
<h3 id="cdpath" tabindex="-1"><a class="header-anchor" href="#cdpath" aria-hidden="true">#</a> $CDPATH</h3>
<p>变量指定 <code>cd</code> 命令可以搜索的路径，路径之间用冒号进行分隔。该变量的功能类似于指定可执行文件搜索路径的变量 <code>$PATH</code>。可以在本地文件 <code>~/.bashrc</code> 中设置该变量。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">cd</span> bash-doc
...
/usr/share/doc/bash-doc
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><h3 id="dirstack" tabindex="-1"><a class="header-anchor" href="#dirstack" aria-hidden="true">#</a> $DIRSTACK</h3>
<p>指代目录栈中顶部的值<sup class="footnote-ref"><a href="#footnote1">[1]</a><a class="footnote-anchor" id="footnote-ref1" /></sup>，目录栈由命令 <code>pushd</code> 和 <code>popd</code> 控制。</p>
<p>该变量相当于命令 <code>dirs</code>，但是 <code>dirs</code> 命令会显示整个目录栈。</p>
<h3 id="editor" tabindex="-1"><a class="header-anchor" href="#editor" aria-hidden="true">#</a> $EDITOR</h3>
<p>脚本所调用的默认编辑器，通常是 <code>vi</code> 或是 <code>emcas</code>。</p>
<h3 id="euid" tabindex="-1"><a class="header-anchor" href="#euid" aria-hidden="true">#</a> $EUID</h3>
<p>有效用户ID。</p>
<p>有效用户ID（EUID）是指当前用户正在使用的用户ID，可以通过 <code>su</code> 命令修改。</p>
<p>{% hint style=&quot;warning&quot; %}</p>
<p><code>$EUID</code> 与 <code>$UID</code> 并不总是相同的。</p>
<p>{% endhint %}</p>
<h3 id="funcname" tabindex="-1"><a class="header-anchor" href="#funcname" aria-hidden="true">#</a> $FUNCNAME</h3>
<p>当前运行函数的函数名。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function-name function">xyz23</span> <span class="token punctuation">(</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>可以参考 <a href="">样例 A-50</a>。</p>
<h3 id="globignore" tabindex="-1"><a class="header-anchor" href="#globignore" aria-hidden="true">#</a> $GLOBIGNORE</h3>
<p>在<RouterLink to="/code/shell/part5/18_2_globbing.html">文件匹配</RouterLink>时所忽略的文件名模式列表。</p>
<h3 id="groups" tabindex="-1"><a class="header-anchor" href="#groups" aria-hidden="true">#</a> $GROUPS</h3>
<p>当前用户所属的用户组。</p>
<p>该变量存储了当前用户所归属的用户组ID列表，是一个数组。内容与记录在文件 <code>/etc/passwd</code> 和文件 <code>/etc/group</code> 中的一致。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>root<span class="token comment"># echo $GROUPS</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h3 id="home" tabindex="-1"><a class="header-anchor" href="#home" aria-hidden="true">#</a> $HOME</h3>
<p>当前用户的主目录，其值通常为 <code>/home/username</code> （参考 <a href="">样例 10-7</a>）。</p>
<h3 id="homename" tabindex="-1"><a class="header-anchor" href="#homename" aria-hidden="true">#</a> $HOMENAME</h3>
...
<h3 id="hosttype" tabindex="-1"><a class="header-anchor" href="#hosttype" aria-hidden="true">#</a> $HOSTTYPE</h3>
<p>主机类型。</p>
<p>类似变量 <a href=""><code>$MACHTYPE</code></a>，用于识别系统硬件信息。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$HOSTTYPE</span>
i686
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="ifs" tabindex="-1"><a class="header-anchor" href="#ifs" aria-hidden="true">#</a> $IFS</h3>
<p>内部字段分隔符。</p>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token string">"<span class="token environment constant">$IFS</span>"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p>通过设置 <code>$IFS</code> 来忽略文件路径名中空格带来的影响。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token assign-left variable"><span class="token environment constant">IFS</span></span><span class="token operator">=</span><span class="token string">"<span class="token variable"><span class="token variable">$(</span><span class="token builtin class-name">printf</span> <span class="token string">'\n\t'</span><span class="token variable">)</span></span>"</span>   <span class="token comment"># 按 David Wheeler 所述。</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>{% hint style=&quot;warning&quot; %}</p>
<p>相比于其他字符，变量 <code>$IFS</code> 在处理空白符时有所不同。</p>
<h4 id="样例-9-1-ifs-与空白符" tabindex="-1"><a class="header-anchor" href="#样例-9-1-ifs-与空白符" aria-hidden="true">#</a> 样例 9-1. $IFS 与空白符</h4>
...
<h3 id="ignoreeof" tabindex="-1"><a class="header-anchor" href="#ignoreeof" aria-hidden="true">#</a> $IGNOREEOF</h3>
<p>忽略 EOF：用于指示 Shell 在注销前需要忽略多少个文件结束符(EOF，contrl-D)。</p>
<h3 id="lc-collate" tabindex="-1"><a class="header-anchor" href="#lc-collate" aria-hidden="true">#</a> $LC_COLLATE</h3>
...
<p>{% endhint %}</p>
<h3 id="lc-ctype" tabindex="-1"><a class="header-anchor" href="#lc-ctype" aria-hidden="true">#</a> $LC_CTYPE</h3>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># *** 调试部分起始 ***</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h3 id="machtype" tabindex="-1"><a class="header-anchor" href="#machtype" aria-hidden="true">#</a> $MACHTYPE</h3>
<p>设备类型。</p>
<p>识别系统硬件。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$MACHTYPE</span>
i686
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="oldpwd" tabindex="-1"><a class="header-anchor" href="#oldpwd" aria-hidden="true">#</a> $OLDPWD</h3>
<p>上一个工作目录(OLD-Print-Working-Directory)，也就是之前所在的目录。</p>
<h3 id="ostype" tabindex="-1"><a class="header-anchor" href="#ostype" aria-hidden="true">#</a> $OSTYPE</h3>
<p>操作系统类型。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$OSTYPE</span>
linux
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="path" tabindex="-1"><a class="header-anchor" href="#path" aria-hidden="true">#</a> $PATH</h3>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$PATH</span>
/bin:/usr/bin:/usr/local/bin/:/usr/X11R6/bin:/sbin:/usr/sbin
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p><code>PATH=${PATH}:/opt/bin</code> 表示添加目录 <code>/opt/bin</code> 到当前的搜索路径中。在脚本中可以通过这种方式临时添加目录到搜索路径。而当脚本结束时，<code>$PATH</code> 就会恢复到原始值（类似于脚本这样的子进程所作出的修改，不会影响到例如 shell 这样的父进程的环境）。</p>
<p>{% hint style=&quot;info&quot; %}</p>
<p>基于安全考虑，通常在 <code>$PATH</code> 中会省略当前工作目录 <code>./</code>。</p>
<p>{% endhint %}</p>
<h3 id="pipestatus" tabindex="-1"><a class="header-anchor" href="#pipestatus" aria-hidden="true">#</a> $PIPESTATUS</h3>
<p>该 <a href="">数组</a> 变量保存了最后运行的前台 <a href="">管道</a> 的 <a href="">退出状态(es)</a>。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$PIPESTATUS</span>
<span class="token number">0</span>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>tcsh% <span class="token function">bash</span>
...
<span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>如果脚本包含了上述代码，应该得到期望的输出是 0 1 0。</p>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>bash$ <span class="token function">ls</span> <span class="token operator">|</span> bogus_command <span class="token operator">|</span> <span class="token function">wc</span>
bash: bogus_command: <span class="token builtin class-name">command</span> not found
 <span class="token number">0</span>       <span class="token number">0</span>                <span class="token number">0</span>
...
<p>{% endhint %}</p>
<h3 id="ppid" tabindex="-1"><a class="header-anchor" href="#ppid" aria-hidden="true">#</a> $PPID</h3>
<p>一个进程的 <code>$PPID</code> 即该进程的父进程的进程ID(pid)。<sup class="footnote-ref"><a href="#footnote2">[2]</a><a class="footnote-anchor" id="footnote-ref2" /></sup></p>
<p>可以与命令 <a href=""><code>pidof</code></a> 进行比较。</p>
<h3 id="prompt-command" tabindex="-1"><a class="header-anchor" href="#prompt-command" aria-hidden="true">#</a> $PROMPT_COMMAND</h3>
<p>该变量存储在主提示符 <code>$PS1</code> 显示之前所需要执行的命令。</p>
<h3 id="ps1" tabindex="-1"><a class="header-anchor" href="#ps1" aria-hidden="true">#</a> $PS1</h3>
<p>主提示符，即在命令行中显示的提示符。</p>
<h3 id="ps2" tabindex="-1"><a class="header-anchor" href="#ps2" aria-hidden="true">#</a> $PS2</h3>
<p>次要提示符，当需要额外输入时出现的提示符。默认显示为 <code>&gt;</code>。</p>
<h3 id="ps3" tabindex="-1"><a class="header-anchor" href="#ps3" aria-hidden="true">#</a> $PS3</h3>
<p>三级提示符，显示在 <code>select</code> 循环中（参考 <a href="">样例 11-30</a>）。</p>
<h3 id="ps4" tabindex="-1"><a class="header-anchor" href="#ps4" aria-hidden="true">#</a> $PS4</h3>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token assign-left variable"><span class="token environment constant">PS4</span></span><span class="token operator">=</span><span class="token string">'$(read time junk &lt; /proc/$$/schedstat; echo "@@@ $time @@@ " )'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h3 id="pwd" tabindex="-1"><a class="header-anchor" href="#pwd" aria-hidden="true">#</a> $PWD</h3>
<p>工作目录（你当前所在的目录）。</p>
...
<span class="token builtin class-name">exit</span> <span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br></div></div><h3 id="shellopts" tabindex="-1"><a class="header-anchor" href="#shellopts" aria-hidden="true">#</a> $SHELLOPTS</h3>
<p>该只读变量记录了 shell 中已启用的 <a href="">选项</a> 列表。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>bash$ <span class="token builtin class-name">echo</span> <span class="token environment constant">$SHELLOPTS</span>
braceexpand:hashall:histexpand:monitor:history:interactive-comments:emacs
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="shlvl" tabindex="-1"><a class="header-anchor" href="#shlvl" aria-hidden="true">#</a> $SHLVL</h3>
<p>当前 shell 的层级，即嵌套了多少层 Bash <sup class="footnote-ref"><a href="#footnote3">[3]</a><a class="footnote-anchor" id="footnote-ref3" /></sup>。如果命令行的层级 <code>$SHLVL</code> 为 1，那么在其中执行的脚本层级则增加到 2。</p>
<p>{% hint style=&quot;info&quot; %}</p>
<p>该变量 <a href="">不受 subshell 影响</a>。当你需要指出嵌套了多少层 subshell 时，需要使用变量 <a href="#$BASH_SUBSHELL"><code>$BASH_SUBSHELL</code></a>。</p>
<p>{% endhint %}</p>
<h3 id="tmout" tabindex="-1"><a class="header-anchor" href="#tmout" aria-hidden="true">#</a> $TMOUT</h3>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 只能在 Bash 2.05b 及之后的版本中成功执行。</span>
...
<h4 id="样例-9-2-限时输入" tabindex="-1"><a class="header-anchor" href="#样例-9-2-限时输入" aria-hidden="true">#</a> 样例 9-2. 限时输入</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<span class="token builtin class-name">exit</span> <span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br></div></div><p>还有一种方法是使用 <a href=""><code>stty</code></a>。</p>
<h4 id="样例-9-3-再来一次-限时输入" tabindex="-1"><a class="header-anchor" href="#样例-9-3-再来一次-限时输入" aria-hidden="true">#</a> 样例 9-3. 再来一次，限时输入</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<span class="token builtin class-name">exit</span> <span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br></div></div><p>可能最简单的方法就是利用 <a href=""><code>read</code></a> 命令的 <code>-t</code> 选项。</p>
<h4 id="样例-9-4-限时-read" tabindex="-1"><a class="header-anchor" href="#样例-9-4-限时-read" aria-hidden="true">#</a> 样例 9-4. 限时 read</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<h4 id="样例-9-5-我是-root-用户吗" tabindex="-1"><a class="header-anchor" href="#样例-9-5-我是-root-用户吗" aria-hidden="true">#</a> 样例 9-5. 我是 root 用户吗？</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>tcsh% <span class="token builtin class-name">echo</span> <span class="token environment constant">$LOGNAME</span>
bozo
...
<h2 id="位置参数" tabindex="-1"><a class="header-anchor" href="#位置参数" aria-hidden="true">#</a> 位置参数</h2>
<h3 id="_0-1-2-等" tabindex="-1"><a class="header-anchor" href="#_0-1-2-等" aria-hidden="true">#</a> $0, $1, $2 等</h3>
...
<p>命令行参数<sup class="footnote-ref"><a href="#footnote4">[4]</a><a class="footnote-anchor" id="footnote-ref4" /></sup>或是位置参数的个数（参考 <a href="">样例 36-2</a>）。</p>
...
<p>{% endhint %}</p>
<h4 id="样例-9-6-参数列表-利用-和-列出参数" tabindex="-1"><a class="header-anchor" href="#样例-9-6-参数列表-利用-和-列出参数" aria-hidden="true">#</a> 样例 9-6. 参数列表：利用 $* 和 $@ 列出参数</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<p>{% endhint %}</p>
<h4 id="样例-9-7-和-的不一致行为" tabindex="-1"><a class="header-anchor" href="#样例-9-7-和-的不一致行为" aria-hidden="true">#</a> 样例 9-7. $* 和 $@ 的不一致行为</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token assign-left variable">LOG</span><span class="token operator">=</span><span class="token variable">$0</span>.log
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>也可以这么使用：</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 该样例由 Matthew Sage 编写。</span>
...
<span class="token builtin class-name">exit</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br></div></div><h3 id="-5" tabindex="-1"><a class="header-anchor" href="#-5" aria-hidden="true">#</a> $_</h3>
<p>该变量被设置为上一个执行的命令的最后一个参数。</p>
<h4 id="样例-9-9-下划线变量" tabindex="-1"><a class="header-anchor" href="#样例-9-9-下划线变量" aria-hidden="true">#</a> 样例 9-9. 下划线变量</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h3 id="-6" tabindex="-1"><a class="header-anchor" href="#-6" aria-hidden="true">#</a> $?</h3>
...
<p>脚本自身的进程 ID<sup class="footnote-ref"><a href="#footnote5">[5]</a><a class="footnote-anchor" id="footnote-ref5" /></sup>。该变量 <code>$$</code> 通常在脚本构建独有的临时文件时被使用（参考 <a href="">样例 32-6</a>，<a href="">样例 16-31</a>，以及 <a href="">样例 15-27</a>）。该方法通常比调用 <a href=""><code>mktemp</code></a> 命令更简单。</p>
...
<li id="footnote2" class="footnote-item"><p>Footnotes placeholder <a href="#footnote-ref2" class="footnote-backref">↩︎</a></p>
</li>
<li id="footnote3" class="footnote-item"><p>Footnotes placeholder <a href="#footnote-ref3" class="footnote-backref">↩︎</a></p>
</li>
<li id="footnote4" class="footnote-item"><p>Footnotes placeholder <a href="#footnote-ref4" class="footnote-backref">↩︎</a></p>
</li>
<li id="footnote5" class="footnote-item"><p>Footnotes placeholder <a href="#footnote-ref5" class="footnote-backref">↩︎</a></p>
</li>
</ol>
</section>
</template>
