...
<h2 id="续行" tabindex="-1"><a class="header-anchor" href="#续行" aria-hidden="true">#</a> 续行</h2>
<ul>
...
<h2 id="语言类型" tabindex="-1"><a class="header-anchor" href="#语言类型" aria-hidden="true">#</a> 语言类型</h2>
<blockquote>
<p>详见 https://clay-wangzhi.com/linux/gainian/code-type/</p>
</blockquote>
<h2 id="false-等价" tabindex="-1"><a class="header-anchor" href="#false-等价" aria-hidden="true">#</a> False 等价</h2>
<table>
<thead>
<tr>
<th>对象/常量</th>
...
<p>is、is not</p>
<h2 id="运算符优先级" tabindex="-1"><a class="header-anchor" href="#运算符优先级" aria-hidden="true">#</a> 运算符优先级</h2>
<ul>
<li>单目运算符 &gt; 双目运算符</li>
...
<h2 id="表达式" tabindex="-1"><a class="header-anchor" href="#表达式" aria-hidden="true">#</a> 表达式</h2>
...
<h2 id="内建函数" tabindex="-1"><a class="header-anchor" href="#内建函数" aria-hidden="true">#</a> 内建函数</h2>
<table>
<thead>
<tr>
<th>内建函数</th>
...
<span class="token builtin">type</span><span class="token punctuation">(</span><span class="token builtin">int</span><span class="token punctuation">)</span> <span class="token comment"># 返回type，意思是这个int类型由type构造出来</span>
<span class="token builtin">type</span><span class="token punctuation">(</span><span class="token builtin">str</span><span class="token punctuation">)</span> <span class="token comment"># 返回type，也是类型</span>
<span class="token builtin">type</span><span class="token punctuation">(</span><span class="token builtin">type</span><span class="token punctuation">)</span> <span class="token comment"># 也是type</span>
