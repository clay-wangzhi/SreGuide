...
一个进程至少有一个主线程。
其他线程称为工作线程。</p>
<h2 id="线程安全" tabindex="-1"><a class="header-anchor" href="#线程安全" aria-hidden="true">#</a> 线程安全</h2>
...
<h2 id="daemon线程应用场景" tabindex="-1"><a class="header-anchor" href="#daemon线程应用场景" aria-hidden="true">#</a> daemon线程应用场景</h2>
<p>主要应用场景有：</p>
<ol>
