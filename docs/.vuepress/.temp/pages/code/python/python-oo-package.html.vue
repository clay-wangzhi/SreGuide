<template><div><h1 id="_9-1-类、实例和封装" tabindex="-1"><a class="header-anchor" href="#_9-1-类、实例和封装" aria-hidden="true">#</a> 9.1 类、实例和封装</h1>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">ClassName</span><span class="token punctuation">:</span>
    语句块
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="类及类属性" tabindex="-1"><a class="header-anchor" href="#类及类属性" aria-hidden="true">#</a> 类及类属性</h3>
<ul>
...
<p>Person 中， x、foo 都是类的属性，<code v-pre>__name__</code>、<code v-pre>__doc__</code>是类的特殊属性</p>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>a <span class="token operator">=</span> Person<span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment"># 实例化</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>使用上面的语法，在类对象名称后面加上一个括号，就调用类的实例化方法，完成实例化。
实例化就真正创建一个改类的对象（实例 instance）。例如</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>tom <span class="token operator">=</span> Person<span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment"># 不同的实例</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的 tom、jerry 都是 Person 类的实例，通过实例化生成了2个不同的实例。</p>
<p>通常，每次实例化后获得的实例，是不同的实例，即使是使用同样的参数实例化，也得到不一样的对象。</p>
<p>Python 类实例化后，会自动调用<code v-pre>__init__</code>方法。这个方式第一个形式参数必须留给 self, 其他形式参数随意。</p>
<p><strong>构造的2个阶段</strong></p>
<p>确切地讲，<code v-pre>tom = Person()</code>过程分为2个阶段：实例化和初始化。</p>
<p><strong><code v-pre>__init__</code>方法</strong></p>
<p>有些人把 Python 的<code v-pre>__init__</code>方法称为构造方法或构造器。</p>
<p>Person() 实例化后，要初始化，要调用的是<code v-pre>__init__(self)</code>方法，可以不定义，如果没有定义会在实例化后<strong>隐式</strong>调用其父类的。</p>
<p>作用：对实例进行初始化</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">Person</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>初始化函数可以多个参数，请注意第一位置必须是 self， 例如<code v-pre>__init__(self, name, age)</code></p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">Person</span><span class="token punctuation">:</span>
...
<p>注意： <code v-pre>__init__()</code>方法不能有返回值，也就是只能是 return None</p>
</blockquote>
<p><strong>实例对象 instance</strong></p>
<p>上例中，类 Person 实例化后获得一个该类的实例，就是实例对象</p>
<p><code v-pre>__init__</code>方法的第一参数 self 就是指代某一个实例自身。</p>
<p>执行<code v-pre>Person('Tom', 20)</code>时，调用<code v-pre>__init__()</code>方法。self.name 就是 tom 对象的 name，name 是保存在了 tom 对象上，而不是 Person 类上，称为 实例变量。</p>
...
<p>tom.showage() 调用时，会把方法的调用者 tom 实例作为第一参数 self 的实参输入<code v-pre>__init__()</code>方法。</p>
...
<tbody>
<tr>
<td><code v-pre>__name__</code></td>
<td>对象名</td>
</tr>
<tr>
<td><code v-pre>__class__</code></td>
<td>对象的类型</td>
</tr>
<tr>
<td><code v-pre>__dict__</code></td>
<td>对象的属性的字典</td>
</tr>
<tr>
<td><code v-pre>__qualname__</code></td>
<td>类的限定名</td>
</tr>
</tbody>
</table>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上例中，可以看到类属性保存在类的<code v-pre>__dict__</code>中，实例属性保存在实例的<code v-pre>__dict__</code>中，如果从实例访问类的属性，也可以借助<code v-pre>__class__</code>找到所属的类，再通过类来访问类属性，例如<code v-pre>tom.__class__.age</code></p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">Person</span><span class="token punctuation">:</span>
    age <span class="token operator">=</span> <span class="token number">3</span>
...
<p><code v-pre>实例.__dict__[变量名]</code>和<code v-pre>实例.变量</code>都可以访问到实例自己的属性（注意这两种访问是有本质区别的）</p>
<p>对实例访问来说，实例的同名变量会<strong>隐藏</strong>掉类变量，或者说是覆盖了这个类变量。但是注意类变量还在那里，并没有真正被覆盖。</p>
<p><strong>实例属性的查找顺序</strong></p>
<p>指的是实例使用<code v-pre>.点号</code>来访问属性，会先找自己的<code v-pre>__dict__</code>，如果没有，然后通过属性<code v-pre>__class__</code>找到自己的类，再去类的<code v-pre>__dict__</code>中找</p>
<blockquote>
<p>注意：如果实例使用<code v-pre>__dict__[变量名]</code>访问变量，将不会按照上面的查找顺序找变量了，这是指明使用字典的 key 查找，不是属性查找</p>
</blockquote>
...
<p>前面的例子中定义的<code v-pre>__init__</code>等方法，这些方法本身都是类的属性，第一个参数必须是 self，而 self 必须指向一个对象，也就是类实例化之后，由实例来调用这个方法。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Person.normal_function()</p>
