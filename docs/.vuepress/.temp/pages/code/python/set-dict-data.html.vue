...
<h3 id="增加" tabindex="-1"><a class="header-anchor" href="#增加" aria-hidden="true">#</a> 增加</h3>
<ul>
<li>add(elem)
<ul>
<li>增加一个元素到 set 中</li>
...
<h3 id="新增和修改" tabindex="-1"><a class="header-anchor" href="#新增和修改" aria-hidden="true">#</a> 新增和修改</h3>
<ul>
<li>d[key] = value
<ul>
