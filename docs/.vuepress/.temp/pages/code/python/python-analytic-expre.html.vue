<template><h1 id="_3-2-列表、集合、字典解析式" tabindex="-1"><a class="header-anchor" href="#_3-2-列表、集合、字典解析式" aria-hidden="true">#</a> 3.2 列表、集合、字典解析式</h1>
<h2 id="列表解析式" tabindex="-1"><a class="header-anchor" href="#列表解析式" aria-hidden="true">#</a> 列表解析式</h2>
<p>列表解析式 List Comprehension，也叫列表推导式。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token comment"># 生成一个列表，元素0~9，将每一个元素加1后的平方值组成新的列表</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>语法</p>
<ul>
...
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token punctuation">[</span>expr <span class="token keyword">for</span> item <span class="token keyword">in</span> iterable <span class="token keyword">if</span> cond1 <span class="token keyword">if</span> cond2<span class="token punctuation">]</span>
等价于
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h2 id="集合解析式" tabindex="-1"><a class="header-anchor" href="#集合解析式" aria-hidden="true">#</a> 集合解析式</h2>
<p>语法</p>
<ul>
<li>{返回值 for 元素 in 可迭代对象 if 条件}</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h2 id="字典解析式" tabindex="-1"><a class="header-anchor" href="#字典解析式" aria-hidden="true">#</a> 字典解析式</h2>
<p>语法</p>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2>
<ul>
...
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token comment"># 排序一定是容器内全体参与</span>
