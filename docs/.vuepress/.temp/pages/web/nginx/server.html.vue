<template><div><h1 id="_3-3-nginxserver块配置" tabindex="-1"><a class="header-anchor" href="#_3-3-nginxserver块配置" aria-hidden="true">#</a> 3.3 nginxSERVER块配置</h1>
...
<li>*泛域名：进支持在最前或最后（<code v-pre>server_name *.baiud.com;</code>）</li>
<li>正则表达式：加<code v-pre>~</code>前缀 (<code v-pre>server_name  www.taohui.tech ~^www\d+\.taohui\.tech$;</code>)</li>
</ul>
