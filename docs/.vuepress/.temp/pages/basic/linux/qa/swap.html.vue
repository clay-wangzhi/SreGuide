<template><div><h1 id="linux下如何增加swap交换分区" tabindex="-1"><a class="header-anchor" href="#linux下如何增加swap交换分区" aria-hidden="true">#</a> linux下如何增加swap交换分区</h1>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code># swapon -s                --查看当前swap情况
# mkswap /dev/sda3
# swapon /dev/sda3
# swapon -s
# vi /etc/fstab
/dev/sda3   swap   swap  defaults  0  0    --添加开机自动挂载
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="大文件扩展swap" tabindex="-1"><a class="header-anchor" href="#大文件扩展swap" aria-hidden="true">#</a> 大文件扩展swap</h2>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code># cd /var
