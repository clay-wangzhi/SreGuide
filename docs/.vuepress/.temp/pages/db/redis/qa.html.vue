...
<h2 id="redis是什么" tabindex="-1"><a class="header-anchor" href="#redis是什么" aria-hidden="true">#</a> Redis是什么</h2>
...
<h2 id="五种类型" tabindex="-1"><a class="header-anchor" href="#五种类型" aria-hidden="true">#</a> 五种类型</h2>
<ol>
...
<h2 id="redis相比memcached有哪些优势" tabindex="-1"><a class="header-anchor" href="#redis相比memcached有哪些优势" aria-hidden="true">#</a> Redis相比memcached有哪些优势</h2>
<ul>
...
<h2 id="如何选择合适的持久化方式" tabindex="-1"><a class="header-anchor" href="#如何选择合适的持久化方式" aria-hidden="true">#</a> 如何选择合适的持久化方式</h2>
...
<h2 id="主从复制简介及过程" tabindex="-1"><a class="header-anchor" href="#主从复制简介及过程" aria-hidden="true">#</a> 主从复制简介及过程</h2>
...
<h2 id="redis有哪几种数据淘汰策略" tabindex="-1"><a class="header-anchor" href="#redis有哪几种数据淘汰策略" aria-hidden="true">#</a> Redis有哪几种数据淘汰策略</h2>
<ul>
<li>
...
<h2 id="redis如何设置密码及验证密码" tabindex="-1"><a class="header-anchor" href="#redis如何设置密码及验证密码" aria-hidden="true">#</a> Redis如何设置密码及验证密码</h2>
<p>设置密码：config set requirepass 123456</p>
<p>授权密码：auth 123456</p>
<h2 id="redis哈希槽的概念" tabindex="-1"><a class="header-anchor" href="#redis哈希槽的概念" aria-hidden="true">#</a> Redis哈希槽的概念</h2>
<p>Redis集群没有使用一致性hash,而是引入了哈希槽的概念，Redis集群有16384个哈希槽，每个key通过CRC16校验后对16384取模来决定放置哪个槽，集群的每个节点负责一部分hash槽。</p>
<h2 id="redis集群之间是如何复制的" tabindex="-1"><a class="header-anchor" href="#redis集群之间是如何复制的" aria-hidden="true">#</a> Redis集群之间是如何复制的</h2>
<p>异步复制</p>
