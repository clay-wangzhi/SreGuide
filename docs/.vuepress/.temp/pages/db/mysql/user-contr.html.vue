...
<h4 id="_2-6-2-db表" tabindex="-1"><a class="header-anchor" href="#_2-6-2-db表" aria-hidden="true">#</a> 2.6.2 db表</h4>
<p>db表列出数据库，用户有权限访问它们。在这里指定的权限适用于一个数据库中的所有表。</p>
<h4 id="_2-6-2-host表" tabindex="-1"><a class="header-anchor" href="#_2-6-2-host表" aria-hidden="true">#</a> 2.6.2 host表</h4>
<p>host表与db表结合使用在一个较好层次上控制特定主机对数据库的访问权限，这可能比单独使用db好些。这个表不受GRANT和REVOKE语句的影响，所以，你可能发觉你根本不是用它。</p>
<h4 id="_2-6-3-tables-priv表" tabindex="-1"><a class="header-anchor" href="#_2-6-3-tables-priv表" aria-hidden="true">#</a> 2.6.3 tables_priv表</h4>
<p>tables_priv表指定表级权限，在这里指定的一个权限适用于一个表的所有列。</p>
<h4 id="_2-6-4-columns-priv表" tabindex="-1"><a class="header-anchor" href="#_2-6-4-columns-priv表" aria-hidden="true">#</a> 2.6.4 columns_priv表</h4>
