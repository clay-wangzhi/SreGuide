...
<h2 id="常用的存储引擎及其特点" tabindex="-1"><a class="header-anchor" href="#常用的存储引擎及其特点" aria-hidden="true">#</a> 常用的存储引擎及其特点</h2>
<h3 id="myisam存储引擎" tabindex="-1"><a class="header-anchor" href="#myisam存储引擎" aria-hidden="true">#</a> MyISAM存储引擎</h3>
...
<h3 id="innodb存储引擎" tabindex="-1"><a class="header-anchor" href="#innodb存储引擎" aria-hidden="true">#</a> InnoDB存储引擎</h3>
...
<h3 id="memory存储引擎" tabindex="-1"><a class="header-anchor" href="#memory存储引擎" aria-hidden="true">#</a> MEMORY存储引擎</h3>
...
<h3 id="archive存储引擎" tabindex="-1"><a class="header-anchor" href="#archive存储引擎" aria-hidden="true">#</a> ARCHIVE存储引擎</h3>
...
<h3 id="csv存储引擎" tabindex="-1"><a class="header-anchor" href="#csv存储引擎" aria-hidden="true">#</a> CSV存储引擎</h3>
<p>数据中转试用，主要特点：</p>
<ul>
<li>其数据格式为.csv格式的文本，可以直接编辑保存</li>
<li>导入导出比较方便，可以将某个表中的数据直接导出为csv，试用Excel办公软件打开；</li>
</ul>
<h2 id="myisam和innodb的主要区别" tabindex="-1"><a class="header-anchor" href="#myisam和innodb的主要区别" aria-hidden="true">#</a> MyISAM和InnoDB的主要区别</h2>
<ul>
...
<h2 id="如何选择合适的存储引擎" tabindex="-1"><a class="header-anchor" href="#如何选择合适的存储引擎" aria-hidden="true">#</a> 如何选择合适的存储引擎</h2>
<p>1、使用场景是否需要事务支持；
