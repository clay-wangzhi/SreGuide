<template><h1 id="_5-ansible变量" tabindex="-1"><a class="header-anchor" href="#_5-ansible变量" aria-hidden="true">#</a> 5 Ansible变量</h1>
<h2 id="变量优先级" tabindex="-1"><a class="header-anchor" href="#变量优先级" aria-hidden="true">#</a> 变量优先级</h2>
