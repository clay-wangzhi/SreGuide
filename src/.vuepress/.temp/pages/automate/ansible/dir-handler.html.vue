<template><h1 id="_4-1-playbook的结构及handler用法" tabindex="-1"><a class="header-anchor" href="#_4-1-playbook的结构及handler用法" aria-hidden="true">#</a> 4.1 Playbook的结构及handler用法</h1>
<h2 id="_1-playbook的结构说明" tabindex="-1"><a class="header-anchor" href="#_1-playbook的结构说明" aria-hidden="true">#</a> 1 playbook的结构说明</h2>
...
<h2 id="_2-target-section" tabindex="-1"><a class="header-anchor" href="#_2-target-section" aria-hidden="true">#</a> 2 Target section</h2>
<p>playbook中的每一个play的目的都是为了让某个或某些主机以某个指定的用户身份执行任务。</p>
<h3 id="_2-1-playbook中的远程用户" tabindex="-1"><a class="header-anchor" href="#_2-1-playbook中的远程用户" aria-hidden="true">#</a> 2.1 Playbook中的远程用户</h3>
<p>playbook中的远程用户和ad-hoc中的使用没有区别，默认不定义，则直接使用ansible.cfg配置中的用户相关的配置。也可在playbook中定义如下：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>- name: /etc/hosts is up to date
  hosts: datacenter
  ...
  tasks:
    - name: server.example.com in /etc/hosts
      lineinfile:
        ...
        state: present
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><h3 id="_2-2-playbook中的hosts" tabindex="-1"><a class="header-anchor" href="#_2-2-playbook中的hosts" aria-hidden="true">#</a> 2.2 Playbook中的hosts</h3>
<p>playbook中的hosts即inentory中的定义主机与主机组，在《Ansible Inventory》中我们讲到了如何选择主机与主机组，在这里也完全适用。</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>- name: start mariadb
  hosts: db,&amp;london
  tasks:
    - name: start mariadb
      service:
        name: mariadb
        state: started
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><h2 id="_3-variable-section" tabindex="-1"><a class="header-anchor" href="#_3-variable-section" aria-hidden="true">#</a> 3 Variable section</h2>
<p>vars设置变量vars指令可用于设置变量，可以设置一个或多个变量。下面的设置方式都是合理的</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code># 设置单个变量
vars:
  var1: value1
...
vars:
  - var1: value1
  - var2: value2
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p>vars可以设置在play级别，也可以设置在task级别：</p>
<p>(1).设置在play级别，该play范围内的task能访问这些变量，其它play范围内则无法访问；</p>
<p>(2).设置在task级别，只有该task能访问这些变量，其它task和其它play则无法访问。</p>
<h2 id="_4-task-section" tabindex="-1"><a class="header-anchor" href="#_4-task-section" aria-hidden="true">#</a> 4 Task section</h2>
<p>play的主体部分是任务列表。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>可以使用ignore_errors来忽略错误信息：</p>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token key atrule">tasks</span><span class="token punctuation">:</span>
  <span class="token punctuation">-</span> <span class="token key atrule">name</span><span class="token punctuation">:</span> run this command and ignore the result
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h2 id="_5-handler-section" tabindex="-1"><a class="header-anchor" href="#_5-handler-section" aria-hidden="true">#</a> 5 Handler section</h2>
<ul>
