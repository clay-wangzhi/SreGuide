<template><h1 id="_4-ansible-playbook" tabindex="-1"><a class="header-anchor" href="#_4-ansible-playbook" aria-hidden="true">#</a> 4 Ansible Playbook</h1>
<h2 id="_1-ansible-playbook简介" tabindex="-1"><a class="header-anchor" href="#_1-ansible-playbook简介" aria-hidden="true">#</a> 1 Ansible Playbook简介</h2>
...
<h3 id="playbook、play和task的关系" tabindex="-1"><a class="header-anchor" href="#playbook、play和task的关系" aria-hidden="true">#</a> playbook、play和task的关系</h3>
<ul>
...
<h2 id="_2-playbook基本语法" tabindex="-1"><a class="header-anchor" href="#_2-playbook基本语法" aria-hidden="true">#</a> 2 Playbook基本语法</h2>
<p>下面是一个简单的ansible-playbook示例，可以了解其构成:</p>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token comment"># cat user.yml</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>配置项说明：</p>
<ul>
<li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>：定义具体需要执行的任务</p>
<ul>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>user: name="{{ user }}" state=absent remove=yes
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h2 id="_3-playbook简单示例" tabindex="-1"><a class="header-anchor" href="#_3-playbook简单示例" aria-hidden="true">#</a> 3 Playbook简单示例</h2>
<p>下面通过playbook管理一个httpd服务器来简单了解下playbook的应用：</p>
<ol>
<li>创建playbook</li>
</ol>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token comment"># cat manage_apache.yml</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><ol>
<li>执行playbook</li>
</ol>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code># ansible-playbook  manage_apache.yml 
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code># ansible-playbook  manage_apache.yml  -vv
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="_4-2-校验playbook语法" tabindex="-1"><a class="header-anchor" href="#_4-2-校验playbook语法" aria-hidden="true">#</a> 4.2  校验playbook语法</h3>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code># ansible-playbook --syntax-check  manage_apache.yml   

playbook: manage_apache.yml
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h3 id="_4-3-测试运行playbook" tabindex="-1"><a class="header-anchor" href="#_4-3-测试运行playbook" aria-hidden="true">#</a> 4.3 测试运行playbook</h3>
<p>通过-C选项可以测试playbook的执行情况，但不会真的执行：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code># ansible-playbook -C  manage_apache.yml  
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><h3 id="_4-4-playbook模块参数的传递方式" tabindex="-1"><a class="header-anchor" href="#_4-4-playbook模块参数的传递方式" aria-hidden="true">#</a> 4.4 playbook模块参数的传递方式</h3>
<p>copy模块的参数传递方式如下</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>tasks:
  - name: copy /etc/passwd to /tmp
    copy: src=/etc/passwd dest=/tmp
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>这是标准的yaml语法，参数部分src=/etc/passwd dest=/tmp是一个字符串，当作copy对应的值。根据4_8 yaml介绍的yaml语法，还可以换行书写。有以下几种方式：</p>
...
<h2 id="_5-multiple-plays" tabindex="-1"><a class="header-anchor" href="#_5-multiple-plays" aria-hidden="true">#</a> 5 Multiple Plays</h2>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code># This is a simple playbook with two plays
