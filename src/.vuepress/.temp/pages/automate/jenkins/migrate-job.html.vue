<template><h1 id="_7-1-jenkins-job迁移" tabindex="-1"><a class="header-anchor" href="#_7-1-jenkins-job迁移" aria-hidden="true">#</a> 7.1 Jenkins Job迁移</h1>
...
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/g62phjjstk.jpeg" alt="img" loading="lazy"></p>
<p>现在具体来看下如何将上面的配置的job从192.168.9.10的Jenkins上迁移到192.168.9.8的机器上。</p>
<h2 id="job-import-plugin导入" tabindex="-1"><a class="header-anchor" href="#job-import-plugin导入" aria-hidden="true">#</a> <strong>Job Import Plugin导入</strong></h2>
...
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/jf3clczyv2.jpeg" alt="img" loading="lazy"></p>
<p>安装完后进入“Manage Jenkins” -&gt; &quot;Configure System&quot;下，找到Job Import Pluguin配置的地方，进行如下设置：</p>
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/eug932owyp.jpeg" alt="img" loading="lazy"></p>
...
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/uov6bpo6hk.jpeg" alt="img" loading="lazy"></p>
<p>在Job Import Plugin界面，下拉选择刚才添加的配置，然后点击Query按钮就可以搜索出配置的Jenkins下的job了，然后选择需要的job进行迁移导入即可：</p>
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/v71i68ivlj.jpeg" alt="img" loading="lazy"></p>
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/o6jxwkuuba.jpeg" alt="img" loading="lazy"></p>
<p>因为有时候旧的Jenkins上的插件新Jenkins上未必有，因此可以根据实际情况勾选是否需要安装必要的插件，如上面的截图所示，需不需要覆盖已有的job也根据实际情况勾选下。导入成功会有如下的提示：</p>
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/sqfvrcd932.jpeg" alt="img" loading="lazy"></p>
<p>有了上面的提示后就可以会到新的Jenkins的首页，查看Job有没有成功进入，并进入导入的job查看设置有没有成功的复制过来，如下所示：</p>
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/7j29p9rg9g.jpeg" alt="img" loading="lazy"></p>
...
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/dg1ouhsl9j.jpeg" alt="img" loading="lazy"></p>
<h2 id="jenkins-cli方式导入" tabindex="-1"><a class="header-anchor" href="#jenkins-cli方式导入" aria-hidden="true">#</a> <strong>Jenkins CLI方式导入</strong></h2>
...
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/2yywfzeqrj.jpeg" alt="img" loading="lazy"></p>
...
<p><img src="https://clay-blog.oss-cn-shanghai.aliyuncs.com/img/xf64g5cl00.jpeg" alt="img" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>记得将URL替换成新Jenkins的URL，User ID和token也替换下</p>
