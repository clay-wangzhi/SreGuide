...
<p><img src="https://gitee.com/clay-wangzhi/blogImg/raw/master/blogImg/image-20200102212417067.png" alt="" loading="lazy"></p>
<p>三个主要应用场景为：</p>
<ul>
...
<h3 id="_1-1-反向代理服务" tabindex="-1"><a class="header-anchor" href="#_1-1-反向代理服务" aria-hidden="true">#</a> 1.1 反向代理服务</h3>
<h4 id="_1-1-1-负载均衡" tabindex="-1"><a class="header-anchor" href="#_1-1-1-负载均衡" aria-hidden="true">#</a> 1.1.1 负载均衡</h4>
<p>负载均衡，一般包含两方面的含义。</p>
<ul>
<li>
...
<h5 id="复制均衡策略" tabindex="-1"><a class="header-anchor" href="#复制均衡策略" aria-hidden="true">#</a> 复制均衡策略</h5>
<p>即内置策略和扩展策略。</p>
<ol>
<li>
...
<h2 id="_2-nginx的优点" tabindex="-1"><a class="header-anchor" href="#_2-nginx的优点" aria-hidden="true">#</a> 2 Nginx的优点</h2>
...
<h2 id="_3-nginx的组成" tabindex="-1"><a class="header-anchor" href="#_3-nginx的组成" aria-hidden="true">#</a> 3 Nginx的组成</h2>
<ol>
<li>Nginx二进制可执行文件
<ul>
...
<h2 id="_4-编译安装nginx" tabindex="-1"><a class="header-anchor" href="#_4-编译安装nginx" aria-hidden="true">#</a> 4 编译安装Nginx</h2>
<h3 id="_4-1-下载nginx" tabindex="-1"><a class="header-anchor" href="#_4-1-下载nginx" aria-hidden="true">#</a> 4.1 下载Nginx</h3>
<blockquote>
...
<h3 id="_4-3-configure" tabindex="-1"><a class="header-anchor" href="#_4-3-configure" aria-hidden="true">#</a> 4.3 Configure</h3>
<p>先安装相关依赖</p>
<blockquote>
<p>gzip模块需要zlib库</p>
...
<h4 id="_5-1-2-空间单位" tabindex="-1"><a class="header-anchor" href="#_5-1-2-空间单位" aria-hidden="true">#</a> 5.1.2 空间单位</h4>
<ul>
<li>b/B：bytes</li>
<li>k/K：kilobytes</li>
<li>m/M：megabytes</li>
...
<h3 id="_6-2-全局块" tabindex="-1"><a class="header-anchor" href="#_6-2-全局块" aria-hidden="true">#</a> 6.2 全局块</h3>
<p>通常包括配置运行Nginx服务器的用户（组）、允许生成的worker process数、Nginx进程PID存放路径、日志的存放路径和类型以及配置文件引入等。</p>
<h3 id="_6-3-events块" tabindex="-1"><a class="header-anchor" href="#_6-3-events块" aria-hidden="true">#</a> 6.3 events块</h3>
...
<h3 id="_6-4-http块" tabindex="-1"><a class="header-anchor" href="#_6-4-http块" aria-hidden="true">#</a> 6.4 http块</h3>
...
<h3 id="_6-5-server块" tabindex="-1"><a class="header-anchor" href="#_6-5-server块" aria-hidden="true">#</a> 6.5 server块</h3>
...
<h3 id="_6-6-location块" tabindex="-1"><a class="header-anchor" href="#_6-6-location块" aria-hidden="true">#</a> 6.6 location块</h3>
