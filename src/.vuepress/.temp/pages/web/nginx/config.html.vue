<template><h1 id="_3-nginx配置文件详解" tabindex="-1"><a class="header-anchor" href="#_3-nginx配置文件详解" aria-hidden="true">#</a> 3. nginx配置文件详解</h1>
<p>配置文件详解</p>
