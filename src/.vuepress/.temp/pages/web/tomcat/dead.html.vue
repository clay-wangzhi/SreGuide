...
<h2 id="_1-2编写背景" tabindex="-1"><a class="header-anchor" href="#_1-2编写背景" aria-hidden="true">#</a> 1.2编写背景</h2>
...
<h1 id="_2-分析步骤" tabindex="-1"><a class="header-anchor" href="#_2-分析步骤" aria-hidden="true">#</a> 2 分析步骤</h1>
<p>根据前面我描述的假死现象，我最先想到的是网络是否出现了问题，是不是有什么丢包严重的情况，于是我开始从</p>
<p>请求的数据流程开始分析，由于我们业务的架构采用的是nginx+tomcat的集群配置，一个请求上来的流向可以用</p>
<p>下图来简单的描述一下：</p>
<h2 id="_2-1检查nginx的网络情况" tabindex="-1"><a class="header-anchor" href="#_2-1检查nginx的网络情况" aria-hidden="true">#</a> 2.1检查nginx的网络情况</h2>
<p>更改nginx的配置，让该台nginx请求只转到本机器的出现问题的tomcat应用上面，在access.log里看是否有网络</p>
<p>请求，结果可以查看到当前所有的网络请求，也就是说可以排除是网络的问题。</p>
<h2 id="_2-2检查tomcat-的网络情况" tabindex="-1"><a class="header-anchor" href="#_2-2检查tomcat-的网络情况" aria-hidden="true">#</a> 2.2检查tomcat 的网络情况</h2>
...
<h1 id="_3-分析jvm内存溢出" tabindex="-1"><a class="header-anchor" href="#_3-分析jvm内存溢出" aria-hidden="true">#</a> 3 分析JVM内存溢出</h1>
<h2 id="_3-1为什么会发生内存泄漏" tabindex="-1"><a class="header-anchor" href="#_3-1为什么会发生内存泄漏" aria-hidden="true">#</a> 3.1<strong>为什么会发生内存泄漏</strong></h2>
...
<h2 id="_3-2快速定位问题" tabindex="-1"><a class="header-anchor" href="#_3-2快速定位问题" aria-hidden="true">#</a> 3.2<strong>快速定位问题</strong></h2>
...
<h1 id="_4-tomcat假死其它情况" tabindex="-1"><a class="header-anchor" href="#_4-tomcat假死其它情况" aria-hidden="true">#</a> 4 Tomcat假死其它情况</h1>
