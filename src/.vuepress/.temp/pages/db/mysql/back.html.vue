...
<h2 id="_1-备份的分类" tabindex="-1"><a class="header-anchor" href="#_1-备份的分类" aria-hidden="true">#</a> 1 备份的分类</h2>
<h3 id="_1-1-按备份的结果来分" tabindex="-1"><a class="header-anchor" href="#_1-1-按备份的结果来分" aria-hidden="true">#</a> 1.1 按备份的结果来分</h3>
<h4 id="_1-1-1-逻辑备份" tabindex="-1"><a class="header-anchor" href="#_1-1-1-逻辑备份" aria-hidden="true">#</a> 1.1.1 逻辑备份</h4>
<p>其备份结果为SQL语句，适合于所有存储引擎，恢复时需要较多时间，逻辑备份时，对于MyISAM存储引擎是需要进行锁表操作的，通过使用的mysqldump就是一种逻辑备份工具</p>
<h4 id="_1-1-2-物理备份" tabindex="-1"><a class="header-anchor" href="#_1-1-2-物理备份" aria-hidden="true">#</a> 1.1.2 物理备份</h4>
...
<h3 id="_1-2-按备份的数据库的内容来分" tabindex="-1"><a class="header-anchor" href="#_1-2-按备份的数据库的内容来分" aria-hidden="true">#</a> 1.2 按备份的数据库的内容来分</h3>
<h4 id="_1-2-1-全量备份" tabindex="-1"><a class="header-anchor" href="#_1-2-1-全量备份" aria-hidden="true">#</a> 1.2.1 全量备份</h4>
<p>是对整个数据库的一个完整备份</p>
<h4 id="_1-2-2-增量备份" tabindex="-1"><a class="header-anchor" href="#_1-2-2-增量备份" aria-hidden="true">#</a> 1.2.2 增量备份</h4>
...
<h2 id="_2-使用mysqldump进行备份" tabindex="-1"><a class="header-anchor" href="#_2-使用mysqldump进行备份" aria-hidden="true">#</a> 2 使用mysqldump进行备份</h2>
