...
<p><img src="images/1536718268668.png" alt="1536718268668" loading="lazy"></p>
...
<p>2、char的最大长度是255。  <img src="images/1536719919287.png" alt="1536719919287" loading="lazy"></p>
<p>3、varchar理论长度是65535字节,实际根本达不到。具体长度与字符编码有关。 <img src="images/1536720096028.png" alt="1536720096028" loading="lazy"></p>
<p><img src="images/1536720113031.png" alt="1536720113031" loading="lazy"></p>
<p>4、一个记录的总长度不能超过65535个字节。</p>
<p>5、大块文本（text）不计算在总长度中,一个大块文本只占用10个字节来保存文本的地址。 <img src="images/1536720763914.png" alt="1536720763914" loading="lazy"></p>
...
<p><img src="images/1536721403493.png" alt="1536721403493" loading="lazy"></p>
...
<p><img src="images/1536723512843.png" alt="1536723512843" loading="lazy"></p>
<hr>
...
<p><img src="images/1536737314504.png" alt="1536737314504" loading="lazy"></p>
...
<p><img src="images/1536736467251.png" alt="1536736467251" loading="lazy"></p>
<h4 id="_2-4-3-查看主键" tabindex="-1"><a class="header-anchor" href="#_2-4-3-查看主键" aria-hidden="true">#</a> 2.4.3 查看主键</h4>
<p><img src="images/1536736627655.png" alt="1536736627655" loading="lazy"></p>
<h4 id="_2-4-4-删除主键" tabindex="-1"><a class="header-anchor" href="#_2-4-4-删除主键" aria-hidden="true">#</a> 2.4.4 删除主键</h4>
<p><img src="images/1536736700169.png" alt="1536736700169" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p><img src="images/1536739081697.png" alt="1536739081697" loading="lazy"></p>
<p>问题：主键和唯一键的区别？</p>
...
<p>为了程序员之间的相互交流  <img src="images/1536739540981.png" alt="1536739540981" loading="lazy"></p>
<h2 id="_3-sql注释" tabindex="-1"><a class="header-anchor" href="#_3-sql注释" aria-hidden="true">#</a> 3 SQL注释</h2>
<p>单行注释：--或#</p>
<p>多行注释：/*    */</p>
<p><img src="images/1536739661909.png" alt="1536739661909" loading="lazy"></p>
<h2 id="_4-数据完整性介绍" tabindex="-1"><a class="header-anchor" href="#_4-数据完整性介绍" aria-hidden="true">#</a> 4 数据完整性介绍</h2>
<p><img src="images/1536739894901.png" alt="1536739894901" loading="lazy"></p>
...
<p><img src="images/1536742477588.png" alt="1536742477588" loading="lazy"></p>
