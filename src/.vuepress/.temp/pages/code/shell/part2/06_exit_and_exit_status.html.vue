<template><h1 id="第六章-退出与退出状态" tabindex="-1"><a class="header-anchor" href="#第六章-退出与退出状态" aria-hidden="true">#</a> 第六章 退出与退出状态</h1>
<blockquote>
...
<blockquote>
<p><img src="http://tldp.org/LDP/abs/images/note.gif" alt="note" loading="lazy"> 当一个脚本以不带参数的 <code>exit</code> 来结束时，脚本的退出状态由脚本最后执行命令决定（<code>exit</code> 命令之前）。</p>
</blockquote>
...
<blockquote>
<p><img src="http://tldp.org/LDP/abs/images/note.gif" alt="note" loading="lazy"> 逻辑非操作符 <a href="http://tldp.org/LDP/abs/html/special-chars.html#NOTREF" target="_blank" rel="noopener noreferrer">!<ExternalLinkIcon/></a> 将会反转测试或命令的结果，并且这将会影响退出状态。</p>
</blockquote>
<p>样例 6-2. 否定一个条件使用!</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token boolean">true</span>    <span class="token comment"># true 是 shell 内建命令。</span>
...
<p><img src="http://tldp.org/LDP/abs/images/caution.gif" alt="caution" loading="lazy"> 某些特定的退出码具有一些特定的<a href="http://tldp.org/LDP/abs/html/exitcodes.html#EXITCODESREF" target="_blank" rel="noopener noreferrer">保留含义<ExternalLinkIcon/></a>，用户不应该在自己的脚本中重新定义它们。</p>
</blockquote>
<hr class="footnotes-sep">
<section class="footnotes">
<ol class="footnotes-list">
<li id="footnote1" class="footnote-item"><p>在函数没有用<a href="http://tldp.org/LDP/abs/html/complexfunct.html#RETURNREF" target="_blank" rel="noopener noreferrer">return<ExternalLinkIcon/></a>来结束这个函数的情况下。 <a href="#footnote-ref1" class="footnote-backref">↩︎</a></p>
</li>
</ol>
</section>
</template>
