...
<h2 id="作用域分类" tabindex="-1"><a class="header-anchor" href="#作用域分类" aria-hidden="true">#</a> 作用域分类</h2>
<ul>
<li>全局作用域
<ul>
<li>在整个程序运行环境中都可见</li>
...
<h2 id="变量名解析原则legb" tabindex="-1"><a class="header-anchor" href="#变量名解析原则legb" aria-hidden="true">#</a> 变量名解析原则LEGB</h2>
<ul>
