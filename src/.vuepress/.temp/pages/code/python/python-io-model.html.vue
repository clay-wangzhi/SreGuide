...
直接得到最终结果结果的，就是同步调用；
不直接得到最终结果的，就是异步调用。</p>
<h3 id="阻塞、非阻塞" tabindex="-1"><a class="header-anchor" href="#阻塞、非阻塞" aria-hidden="true">#</a> 阻塞、非阻塞</h3>
<p>函数或方法调用的时候，是否立刻返回。
立即返回就是非阻塞调用；
不立即返回就是阻塞调用。</p>
...
<h3 id="联系" tabindex="-1"><a class="header-anchor" href="#联系" aria-hidden="true">#</a> 联系</h3>
...
<h2 id="io两个阶段" tabindex="-1"><a class="header-anchor" href="#io两个阶段" aria-hidden="true">#</a> IO两个阶段</h2>
<p>IO过程分两阶段：
...
<h2 id="异步-io" tabindex="-1"><a class="header-anchor" href="#异步-io" aria-hidden="true">#</a> 异步 IO</h2>
