...
<h2 id="多继承" tabindex="-1"><a class="header-anchor" href="#多继承" aria-hidden="true">#</a> 多继承</h2>
<p>一个类继承自多个类就是多继承，它将具有多个类的特征。</p>
<h3 id="多继承弊端" tabindex="-1"><a class="header-anchor" href="#多继承弊端" aria-hidden="true">#</a> 多继承弊端</h3>
...
<h3 id="多继承的缺点" tabindex="-1"><a class="header-anchor" href="#多继承的缺点" aria-hidden="true">#</a> 多继承的缺点</h3>
